---
name: doc-update
description: Documentation update planning and gap analysis. Use when updating docs after code changes, planning documentation refresh, or auditing docs for accuracy.
---
