...
description: Techniques for writing effective reasoning directives — phrase selection, format choice, timing, chain length, and self-verification. Use after selecting a reasoning tier (via reasoning-strategy) to maximize the quality of the model's actual reasoning output.
---
