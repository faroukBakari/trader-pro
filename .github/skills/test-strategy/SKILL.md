---
name: test-strategy
description: Shared test methodology patterns for backend and frontend test agents. Use when planning test suites, decomposing test surfaces, evaluating coverage value, or structuring test validation with post-action reflexion.
---
