...
description: TradingView Trading Terminal bundle maintenance — debugging obfuscated code, patching bundles, RxJS observable patterns, and preservation rules. Use when debugging TV bundle issues, investigating dialog/sync bugs, patching obfuscated JavaScript, or reverse-engineering minified TradingView code.
---
