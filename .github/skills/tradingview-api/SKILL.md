...
description: TradingView Trading Terminal API integration patterns — interface routing, type conventions, import paths, and critical pitfalls. Use when implementing broker/datafeed features, configuring the widget, working with TV type definitions, or extending the TradingView integration layer.
---
