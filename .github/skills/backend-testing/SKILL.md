...
description: Python/pytest backend testing patterns for the trader-pro modular architecture. Use when writing backend tests, analyzing coverage, selecting fixtures, or debugging test failures. Complements test-strategy skill with pytest-specific patterns.
---
