...
| "Account tracking/equity/balance"            | `providers/tws/README.md` (AccountTracker) → `modules/broker/README.md` (account endpoints) → `BROKER-INTEGRATION.md` (frontend integration)               | Provider then module  |
...
- **Interface-Based Component Wiring**: `providers/tws/README.md` (Wiring Interfaces section 2.3, Dependency Inversion Pattern) → `BACKEND_TESTING.md` (QuoteTracker Testing) → `wiring_interfaces.py` (interface contracts) → `quote_tracker.py` (implementation example)
