...
| **"Bar caching/gap detection/read-through cache"** | **`modules/datafeed/README.md` (Cache Management Layer) → `bar_cache_manager.py` (BarCacheManager) → `models/market/bar_cache.py` (TimeRange, PendingRange, CoveredRange)**                                                                                                    | **Module doc first**   |
