...
| playwright | `frontend-visual-verification`, `playwright-mcp` |
| pytest | `backend-testing` |
| reflexion | `test-strategy` |
| screenshots | `frontend-visual-verification` |
| test-methodology | `test-strategy` |
| test-planning | `test-strategy` |
| testing | `frontend-testing` |
| ui-inspection | `playwright-mcp` |
| ui-validation | `frontend-visual-verification` |
| validation | `test-strategy` |
| visual-verification | `frontend-visual-verification` |
