...
description: VS Code prompt file (.prompt.md) spec and design principles. Load when creating or reviewing prompt templates
keywords: [prompt-files, format, specification, variables, templates]
category: prompting
