...
description: Playwright-based visual validation of UI changes. Load when frontend components, styles, or layouts are modified
keywords: [visual-verification, playwright, ui-validation, screenshots]
category: testing
