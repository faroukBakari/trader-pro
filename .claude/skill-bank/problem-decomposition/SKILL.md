...
description: Complex problem breakdown with interfaces and dependencies. Load when a problem has multiple interacting dimensions
keywords: [decomposition, sub-problems, interfaces, dependencies, complexity]
