...
description: Claude Haiku 4.5 flaw catalog with prompt-level mitigations. Load when writing prompts for Haiku-powered subagents
keywords: [haiku, mitigations, flaws, instruction-fragility, hallucination]
category: prompting
