...
description: Request immunity patterns and tier selection for user-facing agents. Load when injecting request validation gates
keywords: [request-immunity, tiers, injection, validation-gates]
category: review
---
