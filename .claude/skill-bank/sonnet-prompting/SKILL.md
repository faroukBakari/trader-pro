...
description: Claude Sonnet 4.5 flaw catalog with prompt-level mitigations. Load when writing prompts for Sonnet-powered agents
keywords: [sonnet, mitigations, sycophancy, constraint-drift, lazy-output]
category: prompting
