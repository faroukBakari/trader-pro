...
from ibapi.order_state import OrderAllocation, OrderState
...
from ibapi.utils import decimalMaxString, floatMaxString, getEnumTypeFromString
...
@staticmethod
def decodeDeltaNeutralContract(
