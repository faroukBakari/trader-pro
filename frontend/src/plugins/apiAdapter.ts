...
export type RequestPromise<T> = Promise<{ status: number; data: T }>
...
export class ApiAdapter {
    ...
    async resolveSymbol(symbol: string): RequestPromise<LibrarySymbolInfo> {
    ...
    async getQuotes(getQuotesRequest: GetQuotesRequest): RequestPromise<Array<QuoteData>> {
