;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [660],
  {
    163300: (e, t, i) => {
      'use strict'
      ;(i.r(t), i.d(t, { OrderViewController: () => Et }))
      var s = i(870122),
        r = i(650151),
        o = i(737538),
        n = i(947488),
          ...
          (a.connect = function () {
            ...
            return (
              (i && !i.closed) ||
                ...
                new C.Observable(function (e) {
                  ;(0, u.innerFrom)(t()).subscribe(e)
                })).subscribe(n)),
                o &&
                  i.add(function () {
                    return (n = s())
        ...
        return (0, a.operate)(function (t, s) {
          for (
            var r = e.length,
              ...
              a = !1,
              h = function (t) {
                ;(0, u.innerFrom)(e[t]).subscribe(
                  new l.OperatorSubscriber(
                    s,
                    function (e) {
                      ;((o[t] = e),
                        a || n[t] || ((n[t] = !0), (a = n.every(I.identity)) && (n = null)))
                    },
                    d.noop,
                  ),
                )
          ...
          t.subscribe(
            new l.OperatorSubscriber(s, function (e) {
              if (a) {
                var t = (0, V.__spreadArray)([e], (0, V.__read)(o), !1)
                s.next(i ? i.apply(void 0, (0, V.__spreadArray)([], (0, V.__read)(t), !1)) : t)
              }
            }),
          )
        })
                      ...
                      new l.OperatorSubscriber(
                        ...
                        function (s) {
                          if (
                            ...
                            ;(e.next(
                              i
                                ? i.apply(void 0, (0, V.__spreadArray)([], (0, V.__read)(n), !1))
                                : n,
                            ),
                              t.some(function (e, t) {
                                return !e.length && r[t]
          ...
          if (
            ...
            return (
              ...
              void (s = (function (e, t) {
                ...
                const i = Date.now()
                return setTimeout(() => {
                  e({ didTimeout: !1, timeRemaining: () => Math.max(0, 50 - (Date.now() - i)) })
                }, 1)
              })(() => (null == i ? void 0 : i()), t))
            )
      ...
      var ee,
        te = i(80118)
      !(function (e) {
        ;((e.makeInitialPrice = (e) => {
          var t, i
          return Boolean(e.trailingStopPips)
            ? null
            : Boolean(e.guaranteedStop)
              ? null !== (t = e.guaranteedStop) && void 0 !== t
                ? t
                : null
              : null !== (i = e.stopLoss) && void 0 !== i
                ? i
                : null
        }),
          (e.makeInitialEnabled = (e) =>
            Boolean(e.trailingStopPips) || Boolean(e.guaranteedStop) || Boolean(e.stopLoss)),
          (e.makeInitialBracketType = (e) =>
            Boolean(e.trailingStopPips) || e.stopType === D.StopType.TrailingStop
              ? L.BracketType.TrailingStop
              : Boolean(e.guaranteedStop) || e.stopType === D.StopType.GuaranteedStop
                ? L.BracketType.GuaranteedStop
                : L.BracketType.StopLoss))
      })(ee || (ee = {}))

      /**
       * BracketInputModel - Manages Take Profit / Stop Loss bracket input controls
       * Handles pips, price, risk in currency ($), and risk in percent (%) calculations
       */
      class ie {
        constructor({
          initialPrice,
          ...
          hasTrailingStopBracket,
        }) {
          // ═══════════════════════════════════════════════════════════════════
          // SECTION 1: Synchronous Initial Values Calculation
          // Calculate pips synchronously if parentPrice$ is a BehaviorSubject
          // ═══════════════════════════════════════════════════════════════════
          const isTakeProfit = initialBracketType === L.BracketType.TakeProfit
          const bracketSideMultiplier = isTakeProfit ? 1 : -1

          const canCalculateSync =
            typeof parentPrice$?.getValue === 'function' && typeof side$?.getValue === 'function'

          let syncPips = null
          if (canCalculateSync && initialPrice !== null) {
            const syncParentPrice = parentPrice$.getValue()
            const syncSideSign = bracketSideMultiplier * side$.getValue()
            if (syncParentPrice !== null) {
              syncPips = (0, te.priceToPips)(
                initialPrice,
                syncParentPrice,
                syncSideSign,
                info.pipSize,
          ...
          // ═══════════════════════════════════════════════════════════════════
          // SECTION 2: Initialize BehaviorSubjects (Reactive State)
          // ═══════════════════════════════════════════════════════════════════
          this.onControlFocused = new Q.Delegate()
          this.roundToStopLimitPriceStepRequired = false

          // Core value streams
          this._value$ = new n.BehaviorSubject(null)
          this._pips$ = new n.BehaviorSubject(syncPips)
          this._price$ = new n.BehaviorSubject(initialPrice)
          this._riskInCurrency$ = new n.BehaviorSubject(null)
          this._riskInPercent$ = new n.BehaviorSubject(null)

          // Control state streams
          this._focusedControl$ = new n.BehaviorSubject(1) // 0=pips, 1=price, 2=$, 3=%
          this._error$ = new n.BehaviorSubject({ res: false })
          this._controlError$ = new n.BehaviorSubject({ res: false })
          this._isValuesInitialized$ = new n.BehaviorSubject(false)
          this._subscriptions = []

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 3: Public Getters
          // ═══════════════════════════════════════════════════════════════════
          ...
          this.setBracketType = (bracketType) => {
            this._bracketType$.next(bracketType)
          }

          this.setControlError = (hasError, message) => {
            this._controlError$.next({ res: hasError, msg: message })
          }

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 5: Bracket Values Change Handler
          // Recalculates unfocused controls when any value changes
          // ═══════════════════════════════════════════════════════════════════
          this._handleBracketsValuesChange = (changeEvent) => {
            const {
              enabled,
              parentPrice: currentParentPrice,
              sideSign: currentSideSign,
              pipValue: currentPipValue,
            ...
            const {
              ...
              pips: currentPips,
              price: currentPrice,
              riskInCurrency: currentRiskCurrency,
            ...
            const {
              ...
              riskInCurrency: calculatedRiskCurrency,
              riskInPercent: calculatedRiskPercent,
          ...
          // ═══════════════════════════════════════════════════════════════════
          // SECTION 6: Observable Factory for Focused Control
          // Returns appropriate observable based on which control is focused
          // ═══════════════════════════════════════════════════════════════════
          this._bracketValuesWithFocusedControlObservable = () =>
            this._focusedControl$.pipe(
              (0, U.switchMap)((controlIndex) => {
                switch (controlIndex) {
                  case 1:
                    return this._priceObservable(controlIndex)
                  case 2:
                    return this._riskInCurrencyObservable(controlIndex)
                  case 3:
                    return this._riskInPercentObservable(controlIndex)
                  default:
                    return this._pipsObservable(controlIndex)
                }
              }),
            )

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 7: Settings Change Handler
          // Updates focus if current control is hidden by settings
          // ═══════════════════════════════════════════════════════════════════
          this._updateFocusIfNeeded = (settings) => {
            const currentFocus = this.getFocusedControl()
            const percentSetting = this._supportCryptoBrackets
              ? 'showCryptoBracketsInPercent'
              : 'showBracketsInPercent'
            const currencySetting = this._supportCryptoBrackets
              ? 'showCryptoBracketsInCurrency'
              : 'showBracketsInCurrency'

            const isPercentHidden = currentFocus === 3 && !settings[percentSetting]
            const isCurrencyHidden = currentFocus === 2 && !settings[currencySetting]

            if (isPercentHidden || isCurrencyHidden) {
              this.setFocusedControl(0) // Fall back to pips
            }
          }

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 8: Private Getters/Setters with Rounding
          // ═══════════════════════════════════════════════════════════════════
          ...
          this._setRiskInCurrency = (value) => {
            this._riskInCurrency$.next((0, q.applyRounding)(value, this._riskInCurrencyFormatter))
          }

          this._setRiskInPercent = (value) => {
            this._riskInPercent$.next((0, q.applyRounding)(value, this._riskInPercentFormatter))
          }

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 9: Validation Rule Checkers Factory
          // ═══════════════════════════════════════════════════════════════════
          this._makeBracketPercentPriceRuleCheckers = () => {
            const checkers = []
            const rules = this._validationRulesByType?.[this._bracketType$.value]

            if (rules !== undefined) {
              for (const rule of rules) {
                checkers.push(
                  (0, X.makeBracketPercentPriceRuleChecker)(rule.options.min, rule.options.max),
                )
              }
            }
            return checkers
          ...
          // ═══════════════════════════════════════════════════════════════════
          // SECTION 10: Stop Loss Types Configuration
          // ═══════════════════════════════════════════════════════════════════
          this.stopLossTypes = (function buildStopLossTypes(supportsTrailing, supportsGuaranteed) {
            const types = [L.BracketType.StopLoss]
            if (supportsTrailing) types.push(L.BracketType.TrailingStop)
            if (supportsGuaranteed) types.push(L.BracketType.GuaranteedStop)
            return types
          })(Boolean(supportTrailingStop), Boolean(supportGuaranteedStop))

          // Debounce the change handler
          this._handleBracketsValuesChange = Z(this._handleBracketsValuesChange, { timeout: 100 })

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 11: Store Input Observable References
          // ═══════════════════════════════════════════════════════════════════
          this._enabled$ = new n.BehaviorSubject(initialEnabled)
          this._bracketType$ = new n.BehaviorSubject(initialBracketType)
          this._equity$ = equity$
          this._pipValue$ = pipValue$
          this._side$ = side$
          this._sideSign$ = side$.pipe((0, P.map)((sideValue) => bracketSideMultiplier * sideValue))
          this._quotes$ = quotes$
          this._amount$ = amount$

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 12: Store Symbol Info Properties
          // ═══════════════════════════════════════════════════════════════════
          this._pipSize = info.pipSize
          this._lotSize = info.lotSize
          this._settings$ = settings$
          this._parentType = parentType
          this._priceType = isTakeProfit ? 1 : 2 // 1=limit, 2=stop
          this._supportCryptoBrackets = Boolean(supportCryptoBrackets)
          this._isStatusEditing = parentType !== 1 || status === E.OrderPanelStatus.Editing

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 13: Initialize Formatters
          // ═══════════════════════════════════════════════════════════════════
          this._pipsFormatter = new A.PriceFormatter({
            priceScale: info.pipSize !== info.minTick ? 10 : 1,
          })
          this._priceFormatter = formatter
          this._riskInCurrencyFormatter = new A.PriceFormatter({ priceScale: 100 })
          this._riskInPercentFormatter = new A.PriceFormatter({ priceScale: 100 })
          this._priceMagnifier = info.priceMagnifier || 1
          this._hasTrailingStopBracket = hasTrailingStopBracket
          this._validationRulesByType = validationRulesByType

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 14: Create Derived Parent Price Observable
          // Adjusts parent price for trailing stops based on quotes
          // ═══════════════════════════════════════════════════════════════════
          this._parentPrice$ = (0, M.combineLatest)({
            ...
            (0, P.map)((combined) => {
              const {
                parentPrice: baseParentPrice,
                orderType: currentOrderType,
                bracketType: currentBracketType,
                quotes: currentQuotes,
                parentSide: currentParentSide,
              } = combined

              // For trailing stops, use quote prices instead of parent price
              if (currentBracketType === L.BracketType.TrailingStop) {
                const isBuySide = currentParentSide === 1

                // Order type 2 = Stop order
                if (currentOrderType === 2) {
                  return isBuySide ? (0, q.getAsk)(currentQuotes) : (0, q.getBid)(currentQuotes)
                }
                // For non-order parent types, use opposite quote
                if (this._parentType !== 1) {
                  return isBuySide ? (0, q.getBid)(currentQuotes) : (0, q.getAsk)(currentQuotes)
                }
              }
              return baseParentPrice
            }),
          )

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 15: Calculate Price Step
          // ═══════════════════════════════════════════════════════════════════
          const minTick = info.minTick || info.pipSize

          this._priceStep = (0, q.getPriceStep)({
            priceType: this._priceType,
            minTick,
            limitPriceStep: info.limitPriceStep,
            stopPriceStep: info.stopPriceStep,
          })

          this.roundToStopLimitPriceStepRequired = (0, q.roundToStepRequired)({
            priceType: this._priceType,
            minTick,
            limitPriceStep: info.limitPriceStep,
            stopPriceStep: info.stopPriceStep,
          ...
          // ═══════════════════════════════════════════════════════════════════
          // SECTION 16: Async Initial Values Calculation
          // Wait for all observables to emit, then calculate all bracket values
          // ═══════════════════════════════════════════════════════════════════
          ;(0, M.combineLatest)({
            ...
            .pipe((0, G.take)(1))
            .subscribe((observableValues) => {
              const {
                parentPrice: asyncParentPrice,
                sideSign: asyncSideSign,
                pipValue: asyncPipValue,
                equity: asyncEquity,
                amount: asyncAmount,
              } = observableValues

              // Determine initial focus and values based on whether price was provided
              let initialFocusedControl = 0
              let initialPipsValue
              let initialPriceValue

              if (initialPrice !== null) {
                // Price was provided (e.g., from dragging bracket line)
                initialFocusedControl = 1 // Focus on price
                initialPipsValue = null
                initialPriceValue = initialPrice
              } else {
                // No price provided, use saved pips or defaults
                initialPipsValue =
                  savedPips !== null ? savedPips : this._getDefaultPips(initialBracketType)
                initialPriceValue = null
              }

              // Calculate all bracket values from the focused control's value
              const {
                pips: calculatedPips,
                price: calculatedPrice,
                riskInCurrency: calculatedRiskCurrency,
                ...
                parentPrice: asyncParentPrice,
                amount: asyncAmount,
                focusedControl: initialFocusedControl,
                pips: initialPipsValue,
                price: initialPriceValue,
                riskInCurrency: null,
                riskInPercent: null,
              })

              // Apply calculated values to all controls
              this.setFocusedControl(initialFocusedControl)
              this._setPips(calculatedPips)
              this._setPrice(calculatedPrice)
              this._setRiskInCurrency(calculatedRiskCurrency)
              this._setRiskInPercent(calculatedRiskPercent)
              this._isValuesInitialized$.next(true)
            })

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 17: Create Focused Control Observable
          // ═══════════════════════════════════════════════════════════════════
          this._bracketValuesWithFocusedControl$ = this._bracketValuesWithFocusedControlObservable()

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 18: Build Public Control Descriptors
          // Each control has: observable value, step, getter, setter, callback
          // ═══════════════════════════════════════════════════════════════════
          const createModifiedCallback = (controlType) => {
            if (orderWidgetStat !== null) {
              return () =>
                orderWidgetStat.setBracketControlModifiedProperty(initialBracketType, controlType)
            }
            return () => {}
          }
          ...
          this.pips = {
            ...
            onModifiedCallback: createModifiedCallback(E.BracketSubControlType.Pips),
          }
          ...
          this.price = {
            ...
            onModifiedCallback: createModifiedCallback(E.BracketSubControlType.Price),
          }
          ...
          this.riskInCurrency = {
            ...
            onModifiedCallback: createModifiedCallback(E.BracketSubControlType.Money),
          }
          ...
          this.riskInPercent = {
            ...
            onModifiedCallback: createModifiedCallback(E.BracketSubControlType.Percent),
          }

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 19: Expose Public Observables
          // ═══════════════════════════════════════════════════════════════════
          ...
          this.isValuesInitialized$ = this._isValuesInitialized$.asObservable()

          // ═══════════════════════════════════════════════════════════════════
          // SECTION 20: Final Configuration
          // ═══════════════════════════════════════════════════════════════════
          this.controlState = this._computeControlState(
            parentType,
            initialBracketType,
            supportModifyBrackets,
            supportModifyTrailingStop,
          ...
          this.currency = currency.length > 0 ? currency : b.t(null, void 0, i(808249))
          this.showRiskControlsAndInfo = showRiskControlsAndInfo
          this.supportTrailingStop = supportTrailingStop
        ...
        _getDefaultPips(e) {
          return e === L.BracketType.TakeProfit
            ? E.BracketDefaultPips.TakeProfit
            : E.BracketDefaultPips.StopLoss
        }
          ...
          o.res
            ...
            : this._error$.next(
                (0, X.checkBracketError)({
                  ...
                  bracketPercentPriceRuleCheckers: this._makeBracketPercentPriceRuleCheckers(),
        ...
        _pipsObservable(e) {
          return this._pips$.pipe(
            (0, U.switchMap)((t) =>
              J([this._price$, this._riskInCurrency$, this._riskInPercent$]).pipe(
                (0, P.map)((i) => {
                  const [s, r, o] = i
                  return {
                    focusedControl: e,
        ...
        _priceObservable(e) {
          return this._price$.pipe(
            (0, U.switchMap)((t) =>
              J([this._pips$, this._riskInCurrency$, this._riskInPercent$]).pipe(
                (0, P.map)((i) => {
                  const [s, r, o] = i
                  return {
                    focusedControl: e,
        ...
        _riskInCurrencyObservable(e) {
          return this._riskInCurrency$.pipe(
            (0, U.switchMap)((t) =>
              J([this._pips$, this._price$, this._riskInPercent$]).pipe(
                (0, P.map)((i) => {
                  const [s, r, o] = i
                  return {
                    focusedControl: e,
        ...
        _riskInPercentObservable(e) {
          return this._riskInPercent$.pipe(
            (0, U.switchMap)((t) =>
              J([this._pips$, this._price$, this._riskInCurrency$]).pipe(
                (0, P.map)((i) => {
                  const [s, r, o] = i
                  return {
                    focusedControl: e,
        ...
        _calculateBracketValues(e) {
          return {
            pips: (0, q.applyRounding)(this._calculatePips(e), this._pipsFormatter),
            price: (0, q.applyRounding)(this._calculatePrice(e), this._priceFormatter),
            riskInCurrency: (0, q.applyRounding)(
              this._calculateRiskInCurrency(e),
              this._riskInCurrencyFormatter,
            ),
            riskInPercent: (0, q.applyRounding)(
        ...
        _calculatePips(e) {
          ...
          switch (n) {
            ...
            default:
              return a
            case 1:
              return null === l ? null : (0, te.priceToPips)(l, r, t, this._pipSize)
            case 2:
              return null === u || null === o
                ? null
                : (0, te.riskInCurrencyToPips)(u, o, i, this._priceMagnifier, this._lotSize)
            case 3:
              return null === d || null === o
                ? null
                : (0, te.riskInPercentToPips)(d, o, s, i, this._priceMagnifier, this._lotSize)
          }
        }
        _calculatePrice(e) {
          const {
          ...
          switch (n) {
            ...
            default:
              ...
              c = (0, te.pipsToPrice)(a, r, t, this._pipSize)
              break
            case 1:
              return l
            case 2:
              if (null === u || null === o) return null
              ;((h = (0, te.riskInCurrencyToPips)(u, o, i, this._priceMagnifier, this._lotSize)),
                (c = (0, te.pipsToPrice)(h, r, t, this._pipSize)))
              break
            case 3:
              if (null === d || null === o) return null
              ;((h = (0, te.riskInPercentToPips)(d, o, s, i, this._priceMagnifier, this._lotSize)),
                (c = (0, te.pipsToPrice)(h, r, t, this._pipSize)))
          }
          return this.roundToStopLimitPriceStepRequired
            ? (0, y.roundToStepByPriceTypeAndSide)(c, this._priceStep, this._priceType, t)
            : c
        }
        _calculateRiskInCurrency(e) {
          ...
          switch (n) {
            ...
            default:
              return c
                ? null
                : (0, te.pipsToRiskInCurrency)(a, o, i, this._priceMagnifier, this._lotSize)
            case 1:
              return null === l || c
                ? null
                : ((h = (0, te.priceToPips)(l, r, t, this._pipSize)),
                  (0, te.pipsToRiskInCurrency)(h, o, i, this._priceMagnifier, this._lotSize))
            case 2:
              return u
            case 3:
              return null === d || c
                ? null
                : ((h = (0, te.riskInPercentToPips)(
                    d,
                    o,
                    s,
                    i,
        ...
        _calculateRiskInPercent(e) {
          ...
          switch (n) {
            ...
            default:
              return c
                ? null
                : (0, te.pipsToRiskInPercent)(a, o, s, i, this._priceMagnifier, this._lotSize)
            case 1:
              return null === l || c
                ? null
                : ((h = (0, te.priceToPips)(l, r, t, this._pipSize)),
                  (0, te.pipsToRiskInPercent)(h, o, s, i, this._priceMagnifier, this._lotSize))
            case 2:
              return null === u || null === o
                ? null
                : ((h = (0, te.riskInCurrencyToPips)(u, o, i, this._priceMagnifier, this._lotSize)),
        ...
        _computeControlState(e, t, i, s, r) {
          const o =
              ...
              t === L.BracketType.TrailingStop &&
              !s &&
              this._hasTrailingStopBracket,
            n =
              this._isStatusEditing &&
              t !== L.BracketType.TakeProfit &&
              this.getEnabled() &&
              !s &&
              this._hasTrailingStopBracket,
      ...
      class se {
          ...
          ;((this._stopSubscriptions$ = new o.Subject()),
            ...
            (this._onStatusChanged = (e, t) => {
              ;(this._headerState.setTitle(this._title(e)),
                ...
                this._headerState.setOrderPresets(this._hasPresetsButton(e) ? [] : void 0),
            ...
            (this._isOrderPresetsEnabled = b),
            (0, M.combineLatest)({ status: n, mode: r })
              .pipe(h(this._stopSubscriptions$))
              .subscribe(({ status: e, mode: t }) => this._onStatusChanged(e, t)),
            (0, M.combineLatest)({ status: n, mode: r })
              .pipe((0, G.take)(1))
              .subscribe(({ status: e, mode: i }) => {
                ;(this._onStatusChanged(e, i),
                  ...
                  this._headerState.setIsTradable(u))
              }),
            s && s.pipe(h(this._stopSubscriptions$)).subscribe(this._onQuotes),
            void 0 !== _ &&
              _.pipe(h(this._stopSubscriptions$)).subscribe((e) =>
        ...
        _hasBackButton(e, t) {
          return (
            t === E.OrderEditorDisplayMode.Panel &&
            (this._isExistingOrder || 1 !== this._parentType || e === E.OrderPanelStatus.Preview)
          )
        }
        _hasPresetsButton(e) {
          return (
            this._isOrderPresetsEnabled &&
            (e === E.OrderPanelStatus.Active || e === E.OrderPanelStatus.Wait) &&
            1 === this._parentType
          )
        }
        _hasCloseButton(e) {
          return (
            e !== E.OrderEditorDisplayMode.ResizableDrawer && _.enabled('order_panel_close_button')
          )
        }
        _title(e) {
          return e === E.OrderPanelStatus.Preview
            ? b.t(null, void 0, i(88346))
            : this._displaySymbolName
        }
        _text(e) {
          if (e !== E.OrderPanelStatus.Preview) {
            if (!this._isExistingOrder || void 0 === this._data || void 0 === this._formatter)
              return this._brokerName || void 0
            if (1 === this._parentType) return b.t(null, void 0, i(258063)) + ' ' + this._data.id
            if (2 === this._parentType || 3 === this._parentType) {
              ...
              return (
                (1 === e ? b.t(null, void 0, i(728257)) : b.t(null, void 0, i(13009))) +
                ' ' +
                t +
                ' @ ' +
                s
      ...
      var re = (function (e) {
        ...
        oe = {
          setInterval: function () {
            ...
            return ((null == i ? void 0 : i.setInterval) || setInterval).apply(
              void 0,
              (0, V.__spreadArray)([], (0, V.__read)(e), !1),
            )
          },
        ...
        ae = (function (e) {
          ...
          return (
            ...
            (t.prototype.requestAsyncId = function (e, t, i) {
              return (void 0 === i && (i = 0), oe.setInterval(e.flush.bind(e, this), i))
            }),
        ...
        ue = (function () {
          ...
          return (
            ...
            (e.now = le.dateTimestampProvider.now),
            e
          )
        })(),
        de = new ((function (e) {
        ...
        he = de,
        ce = { leading: !0, trailing: !1 }
      var pe = i(337160)
      function _e(e, t, i) {
        ;(void 0 === e && (e = 0), void 0 === i && (i = he))
        var s = -1
        return (
          null != t && ((0, pe.isScheduler)(t) ? (i = t) : (s = t)),
          new C.Observable(function (t) {
            var r,
        ...
        return (
          ...
          (0, a.operate)(function (e, t) {
            var i = !1,
              ...
              a = !1,
              h = function () {
                ;(null == o || o.unsubscribe(), (o = null), d && (_(), a && t.complete()))
              },
              c = function () {
                ;((o = null), a && t.complete())
              },
              p = function (e) {
                return (o = (0, u.innerFrom)(s(e)).subscribe(new l.OperatorSubscriber(t, h, c)))
              },
              _ = function () {
                if (i) {
                  i = !1
      ...
      class be {
        constructor({
          ...
          ;((this.baseCurrency = null),
            (this.onControlFocused = new Q.Delegate()),
            (this._formattedQuotes$ = new n.BehaviorSubject({ ask: ' ', bid: ' ' })),
        ...
        subscribe() {
          ...
          const e = this._quotes$.subscribe((e) => {
            ...
            t = this._quotes$.pipe(ye(2e3, de, { leading: !0, trailing: !0 })).subscribe((e) => {
        ...
        _generateText(e) {
          ...
          return (
            ...
            (t.spread = (0, z.isNumber)(e.spread)
        ...
        _generateRestrictionTypes(e) {
          const t = []
          return (
            e.isHalted && t.push(L.RestrictionType.Halted),
            e.isHardToBorrow && t.push(L.RestrictionType.HardToBorrow),
            e.isNotShortable && t.push(L.RestrictionType.NotShortable),
            t
          )
        }
      }
      ...
      const ke = b.t(null, void 0, i(402043))
      function me(e, t) {
      ...
      class fe {
        ...
        format(e, t) {
          return this._formatter.format(e, { ...t, ignoreLocaleNumberFormat: !0 })
        }
        parse(e, t) {
      ...
      class Se {
        constructor({
          ...
          supportStopOrdersInBothDirections: k,
          supportStopLimitOrdersInBothDirections: m,
          supportStrictCheckingLimitOrderPrice: f,
        }) {
          var S, C
          ;((this.id = (0, x.randomHashN)(6)),
            ...
            (this.setAbsolutePrice = (e) => {
              var t
              const i = (0, q.parseValue)(e, this.formatter)
              if (!i.res) {
                const i =
                ...
                .subscribe((t) => {
                  ...
                  switch (u) {
                    case 'stop':
                      ...
                      break
                    case 'ask':
                      const e = this._priceToIndex((0, q.getAsk)(i))
                      o = Math.round(r - e)
                      break
                    case 'bid':
                      const t = this._priceToIndex((0, q.getBid)(i))
                      o = Math.round(r - t)
                  }
              ...
              ;(0, M.combineLatest)({
                ...
                .subscribe((i) => {
                  ...
                  ;(this._roundToStepRequired() || t) &&
                    (e = (0, y.roundToStepByPriceTypeAndSide)(
                      e,
                      this.getStep(e),
                      this.priceType,
                      o,
                  ...
                  switch (l) {
                    case 'stop':
                      null !== r && (u = Math.round(a - r.index))
                      break
                    case 'ask':
                      const e = this._priceToIndex((0, q.getAsk)(s))
                      u = Math.round(a - e)
                      break
                    case 'bid':
                      const t = this._priceToIndex((0, q.getBid)(s))
                      u = Math.round(a - t)
                  }
                  this._setPrice({
                    index: a,
                ...
                .subscribe((t) => {
                  ...
                  switch (a) {
                    case 'stop':
                      ...
                      break
                    case 'ask':
                      const t = this._priceToIndex((0, q.getAsk)(i))
                      n = Math.round(t + e)
                      break
                    case 'bid':
                      const r = this._priceToIndex((0, q.getBid)(i))
                      n = Math.round(r + e)
                  }
            ...
            (this._updateFocusIfNeeded = (e) => {
              1 !== this.getFocusedControl() ||
                (!this.isRelativePriceControlHidden && e.showRelativePriceControl) ||
            ...
            (this._setError = (e) => {
              ...
              if (a === E.OrderPanelStatus.Wait) return void this._error$.next({ res: !1 })
              if (n.res) return void this._error$.next(n)
              let l = { res: !1 },
                u = { res: !1 }
              if (null === t) l = { res: !0, severity: 'error', msg: b.t(null, void 0, i(845542)) }
              else {
                {
                  const e = this.getStep(t.value)
                  if (((u = this._checkPriceWarning(t.value, s, r)), null !== o && 2 !== o)) {
                    const i = (0, q.getQuotePrice)(s, r)
                    l = (0, Pe.validatePrice)({
                      price: t.value,
                      askOrBid: i,
                      orderType: o,
                      side: r,
                      ...
                      step: e,
                      isStatusEditing: a === E.OrderPanelStatus.Editing,
            ...
            (this.supportStopOrdersInBothDirections = Boolean(k)),
            (this.supportStopLimitOrdersInBothDirections = Boolean(m)),
            (this.supportStrictCheckingLimitOrderPrice = Boolean(f)),
            ...
            (this._variableMinTickData = r.variableMinTick
              ? (0, N.makeVariableMinTickData)(this._minTick, r.variableMinTick)
              : void 0))
          const $ = this.getStep()
          ;((this.indexToPrice = (0, N.makePriceIndexToPriceConverter)(
            $,
            this._variableMinTickData,
          )),
            (this._priceToIndex = (0, N.makePriceToPriceIndexConverter)(
              $,
              this._variableMinTickData,
            )),
            ...
            (this.value$ = this._value$.asObservable()),
            (this.focusedControl$ = this._focusedControl$.asObservable()),
            (this.error$ = this._error$.pipe((0, ve.distinctUntilChanged)(me))),
            (this._stopPriceControlData$ = (0, M.combineLatest)({
              stopPriceControlData: null != v ? v : (0, w.of)(null),
              orderType: this.orderType$,
            }).pipe(
              (0, P.map)((t) => {
              ...
              (0, ve.distinctUntilChanged)(),
            )),
            (this.isRelativePriceControlHidden = this._roundToStepRequired()),
            g ||
              this.isRelativePriceControlHidden ||
              !c().showRelativePriceControl ||
              this.setFocusedControl(1),
            (this.modifiedAbsolutePriceControlStat =
              null !== h
                ? () => h.setPriceControlModifiedProperty(E.PriceSubControlType.Absolute)
                : () => {}),
            (this.modifiedRelativePriceControlStat =
              null !== h
                ? () => h.setPriceControlModifiedProperty(E.PriceSubControlType.Relative)
                : () => {}),
            void 0 !== p && this.setPriceValue(p, !0))
          const T = null != _ ? _ : []
          this._priceRules = null !== (S = T.filter(this._isPriceRules)) && void 0 !== S ? S : []
          const V =
              null !== (C = T.filter(R.isStopLimitPercentValidationRule)) && void 0 !== C ? C : [],
            I =
              1 === this.priceType ? R.isLimitPercentValidationRule : R.isStopPercentValidationRule
          V.filter(I).forEach((e) => {
            this._stopLimitPercentPriceRuleCheckers.push(
              (0, Pe.makeStopLimitPercentPriceRuleChecker)(e.options.min, e.options.max),
            )
          })
        }
        subscribe() {
          const e = this._settings$.subscribe(this._updateFocusIfNeeded),
            ...
            i = (0, M.combineLatest)({
              ...
              side: this.side$,
              orderType: this.orderType$,
              controlError: this._controlError$.pipe((0, ve.distinctUntilChanged)(me)),
              status: this._status$,
            ...
            s = (0, M.combineLatest)({
              ...
              ;((s = i.res && 'error' === i.severity ? null : s), this._value$.next(s))
            })
        ...
        resetPrice() {
          ;(this.setControlError(!1),
            this.setFocusedControl(
              this._getSettings().showRelativePriceControl && !this.isRelativePriceControlHidden
                ? 1
                : 0,
            ),
            (0, M.combineLatest)([this.quotes$, this.side$])
              .pipe((0, G.take)(1))
              .subscribe(([e, t]) => {
                this.setPriceValue(1 === t ? (0, q.getAsk)(e) : (0, q.getBid)(e), !1)
              }))
        }
        _checkPriceWarning(e, t, i) {
          const s = this._priceRules.find((s) => this._isDistanceRuleViolated(e, t, s, i))
          return s
            ? { res: !0, severity: s.severity, msg: ke.format({ brokerTitle: this._brokerTitle }) }
            : { res: !1, msg: void 0 }
        }
        ...
        _roundToStepRequired() {
          return (0, q.roundToStepRequired)({
            priceType: this.priceType,
            minTick: this._minTick,
            limitPriceStep: this._instrumentInfo.limitPriceStep,
            stopPriceStep: this._instrumentInfo.stopPriceStep,
      ...
      var Ce = i(960521),
        $e = i.n(Ce)
      function Te(e, t) {
        return (0, q.getLast)(e) || (0, q.getQuotePrice)(e, t) || 0
      }
      class Me {
        constructor({
          stopPriceModel: e,
          ...
          ;((this._subscriptions = []),
            (this._calculateLimitModelPrice = (e) => {
              ...
              const i = this._limitPriceModel.getStep(t),
                s = 1 === e ? 1 : -1
              return new ($e())(i).mul(s).plus(t).toNumber()
            }),
            (this._orderType$ = i),
            (this._side$ = s),
            (this._stopPriceModel = e),
            (this._limitPriceModel = t),
            (this.price$ = (0, M.combineLatest)({
              orderType: i,
              side: s,
              quotes: r,
              stopPrice: e.value$,
      ...
      class xe {
        constructor({
          ...
          initialOrderSizeCalculatorValue: u,
          initialLastRiskQuantityType: d,
          stopLossAvailableGetter: h,
          initialLastUsedQuantityType: c,
          info: p,
          currency: _,
          orderWidgetStat: y,
          ...
          var g
          ;((this.formatter = (0, Ve.numberFormattersParsersChain)({
            chain: [
              (0, Ie.prohibitNanOnParseStep)(),
              (0, Oe.decimalNumberMagnitudeStep)({ standardNotationOnly: !0 }),
              (0, Be.signumStep)({ negativeSign: Be.longMinusSign }),
            ],
          })),
            (this.riskInCurrencyFormatter = new A.PriceFormatter({ priceScale: 100 })),
            (this.riskInPercentFormatter = new A.PriceFormatter({ priceScale: 100 })),
            (this.convertedValues$ = new S.ReplaySubject(1)),
            (this.riskStep = 0.01),
            (this.onControlFocused = new Q.Delegate()),
            (this._subscriptions = []),
            (this._value$ = new n.BehaviorSubject(null)),
            ...
            (this.setInputTypeAndValue = (e, t) => {
              ;(this._setInputType(e),
                'units' === e ? this.quantity.setValue(t) : this.orderSizeCalculator.setValue(t),
                this.setControlError(!1))
            }),
            ...
            (this.getLastRiskQuantityType = () => this._lastRiskQuantityType$.getValue()),
            (this.getLastUsedQuantityType = () => this._lastUsedQuantityType$.getValue()),
            (this.getFocusedControl = () => this._focusedControl$.getValue()),
            (this.getError = () => this._error$.getValue()),
            (this.getQuantityMetainfo = () => this._quantityMetainfo$.getValue()),
            (this.setFocusedControl = (e) => {
              this._focusedControl$.next(e)
            }),
            ...
            (this._setQuantity = (e) => {
              this._quantity$.next((0, q.applyRounding)(e, this.formatter))
            }),
            (this._setOrderSizeCalculator = (e) => {
              this._orderSizeCalculator$.next((0, q.applyRounding)(e, this.formatter))
            }),
            (this._setRiskInCurrency = (e) => {
              var t
              null === (t = this._riskInCurrency$) ||
                void 0 === t ||
                t.next((0, q.applyRounding)(e, this.riskInCurrencyFormatter))
            }),
            (this._setRiskInPercent = (e) => {
              var t
              null === (t = this._riskInPercent$) ||
                void 0 === t ||
                t.next((0, q.applyRounding)(e, this.riskInPercentFormatter))
            }),
            (this.qty = p.qty),
            (this.units = p.units),
            ...
            (this._settings$ = o),
            (this._stopLossAvailableGetter = h),
            (this._quantity$ = new n.BehaviorSubject(
              null !== (g = null != a ? a : this.qty.default) && void 0 !== g ? g : null,
            )),
            (this._orderSizeCalculator$ = new n.BehaviorSubject(u)),
            (this._orderSizeCalculatorQuantityType$ = new n.BehaviorSubject(l)),
            (this._lastRiskQuantityType$ = new n.BehaviorSubject(d)),
            (this._lastUsedQuantityType$ = new n.BehaviorSubject(null != c ? c : 'units')),
            ...
            (this.lastRiskQuantityType$ = this._lastRiskQuantityType$.asObservable()),
            (this.lastUsedQuantityType$ = this._lastUsedQuantityType$.asObservable()),
            (this.focusedControl$ = this._focusedControl$.asObservable()),
            (this.error$ = this._error$.asObservable()),
            (this.quantityMetainfo$ = this._quantityMetainfo$.asObservable()))
          const v = () => {
            if (null !== y && !this._isOrderSizeCalculatorEnabled)
              return y.setQtyControlModifiedProperty(E.QuantitySubControlType.Units)
          }
          ;((this.quantity = {
            value$: this._quantity$.asObservable(),
            getValue: () => this._quantity$.getValue(),
            setValue: this._setQuantity,
            onModifiedCallback: v,
            calculatorUsedStat: () => (null !== y ? y.setCalculatorUsedProperty() : () => {}),
          }),
            ...
            h() ||
              !u ||
              c !== l ||
              ('money' !== c && 'equityPercent' !== c) ||
              this.setInputTypeAndValue(c, u),
            this._isOrderSizeCalculatorEnabled ||
              ((this._riskInCurrency$ = new n.BehaviorSubject(null)),
              (this._riskInPercent$ = new n.BehaviorSubject(null)),
              (this.riskInCurrency = {
                value$: this._riskInCurrency$.asObservable(),
                getValue: () => (0, r.ensureDefined)(this._riskInCurrency$).getValue(),
                setValue: this._setRiskInCurrency,
                onModifiedCallback: () =>
                  null !== y
                    ? y.setQtyControlModifiedProperty(E.QuantitySubControlType.RiskInCurrency)
                    : () => {},
                calculatorUsedStat: () => (null !== y ? y.setCalculatorUsedProperty() : () => {}),
              }),
              (this.riskInPercent = {
                value$: this._riskInPercent$.asObservable(),
                getValue: () => (0, r.ensureDefined)(this._riskInPercent$).getValue(),
                setValue: this._setRiskInPercent,
                onModifiedCallback: () =>
                  null !== y
                    ? y.setQtyControlModifiedProperty(E.QuantitySubControlType.RiskInPercent)
                    : () => {},
                calculatorUsedStat: () => (null !== y ? y.setCalculatorUsedProperty() : () => {}),
              }),
        ...
        subscribe() {
            ...
            const t = this._inputType$.subscribe((e) => {
                  ...
                  this._quantityMetainfo$.next(
                    null !==
                      (s =
                        null ===
                          (i =
                            null === (t = this._availableQuantityTypeInfos) || void 0 === t
                              ? void 0
                              : t[e]) || void 0 === i
                          ? void 0
                          : i.quantityMetainfo) && void 0 !== s
                      ? s
                      : this.qty,
                  ))
              }),
              i = this._focusedControl$
                ...
                .subscribe((e) => {
                  ...
                  5 === t && this._quantity$.value !== s.units && this._setQuantity(s.units)
                }),
              s = this.stopLossAvailable$
                .pipe(
                  (0, ve.distinctUntilChanged)(),
                  skip(1),
                  withLatestFrom(this.convertedValues$, this._inputType$),
                )
                .subscribe(([, e, t]) => {
                  'units' !== t && this.setInputTypeAndValue('units', e.units)
                }),
              r = this.stopLossAvailable$
                .pipe(
                  (0, ve.distinctUntilChanged)(),
                  withLatestFrom(
                    this._settings$,
                ...
                .subscribe(([e, t, i, s]) => {
                  ...
                  t.enableQuantityInRisk &&
                    ...
                    null !== i &&
                    void 0 !==
                      (null === (r = this.getAvailableQuantityTypeInfos()) || void 0 === r
                        ? void 0
                        : r[i]) &&
                    'riskInCurrency' !== s &&
                    'riskInPercent' !== s &&
          ...
          const t = (0, M.combineLatest)({
            units: this._quantity$,
            controlError: this._controlError$,
            focus: this._focusedControl$,
            orderSizeCalculator: this._orderSizeCalculator$,
            orderSizeCalculatorQuantityType: this._orderSizeCalculatorQuantityType$,
          })
            .pipe((0, ve.distinctUntilChanged)(we.default))
            .subscribe((e) => {
              var t, i
              const {
                units: s,
                controlError: r,
                focus: o,
                orderSizeCalculator: n,
                orderSizeCalculatorQuantityType: a,
              } = e
              const l =
                  null !== a
                    ? null ===
                      ...
                      : i.quantityMetainfo
                    : void 0,
                u = 5 === o && void 0 !== l ? (0, De.checkQtyError)(l, n, !0) : void 0,
                d = (0, De.checkQtyError)(this.qty, s, !0),
                h = r.res ? r.msg : (null == u ? void 0 : u.msg) || d.msg
              ;(this._error$.next({ res: r.res || (null == u ? void 0 : u.res) || d.res, msg: h }),
                this._value$.next(
                  r.res || (null == u ? void 0 : u.res) || d.res || null === o ? null : s,
                ))
            })
        ...
        _calculateQuantityValues(e) {
          return {
            quantity: (0, q.applyRounding)(this._calculateQuantity(e), this.formatter),
            riskInCurrency: (0, q.applyRounding)(
              this._calculateRiskInCurrency(e),
        ...
        _riskInCurrencyObservable(e) {
          return (0, r.ensureDefined)(this._riskInCurrency$).pipe(
            (0, U.switchMap)((t) =>
              J([this._quantity$, (0, r.ensureDefined)(this._riskInPercent$)]).pipe(
                (0, P.map)((i) => {
                  const [s, r] = i
        ...
        _riskInPercentObservable(e) {
          return (0, r.ensureDefined)(this._riskInPercent$).pipe(
            (0, U.switchMap)((t) =>
              J([this._quantity$, (0, r.ensureDefined)(this._riskInCurrency$)]).pipe(
                (0, P.map)((i) => {
                  const [s, r] = i
        ...
        _calculateQuantity(e) {
          ...
          switch (t) {
            ...
            case 2:
              return null === o || null === n ? null : Ee(o, a, n, i, this.qty.step, this._lotSize)
          }
        }
        _calculateRiskInCurrency(e) {
          const {
          ...
          switch (t) {
            case 0:
              return null === s || null === n ? null : qe(s, n, i, this._lotSize)
            case 1:
              return r
            case 2:
              if (null === o || null === n) return null
              return qe(Ee(o, a, n, i, this.qty.step, this._lotSize), n, i, this._lotSize)
            default:
              return null === s || null === n ? null : qe(s, n, i)
          }
        }
        _calculateRiskInPercent(e) {
          const {
          ...
          switch (t) {
            case 0:
            default:
              return null === s || l ? null : Re(s, n, i, a, this._lotSize)
            case 1:
              if (null === r || l) return null
              return Re(Le(r, n, i, this.qty.step, this._lotSize), n, i, a, this._lotSize)
            case 2:
              return o
          }
        }
      ...
      class Ne {
        constructor({
          ...
          ;((this.formatter = Ae.defaultQuantityFormatter),
            (this.onControlFocused = new Q.Delegate()),
            (this._value$ = new n.BehaviorSubject(null)),
            ...
            (this._controlError$ = new n.BehaviorSubject({ res: !1 })),
            (this._baseCurrencyCryptoBalanceValue$ = new n.BehaviorSubject(null)),
            (this._quoteCurrencyCryptoBalanceValue$ = new n.BehaviorSubject(null)),
            (this._subscriptions = []),
            ...
            (this._setBaseCurrencyQuantity = (e) => {
              this._baseCurrencyQuantity$.next((0, q.applyRounding)(e, this.formatter))
            }),
            (this._setQuoteCurrencyQuantity = (e) => {
              this._quoteCurrencyQuantity$.next((0, q.applyRounding)(e, this.formatter))
            }),
            (this.info = e),
            (this.side$ = o),
            (this.getSide = a),
            ...
            (this.quoteCurrencyUiParams$ = t.pipe(
              (0, P.map)((t) => {
                const i = (0, Ce.Big)(t).mul(e.qty.step).toNumber(),
                  s = (0, y.roundUpToPowerOf10)(i),
                  r = (0, Ce.Big)(t).mul(e.qty.min).toNumber()
                return { min: (0, ze.alignToStep)(r, s), step: s }
              }),
            )),
            (this.quantity = {
              ...
              onModifiedCallback:
                null !== l
                  ? () => l.setQtyControlModifiedProperty(E.QuantitySubControlType.BaseCurrency)
                  : () => {},
            }),
            (this.quoteCurrencyQuantity = {
              ...
              onModifiedCallback:
                null !== l
                  ? () => l.setQtyControlModifiedProperty(E.QuantitySubControlType.QuoteCurrency)
                  : () => {},
            }),
            (this._quantityValuesWithFocusedControl$ =
              this._quantityValuesWithFocusedControlObservable()))
        ...
        subscribe() {
          ;(null !== this._baseCurrencyCryptoBalance$ &&
            this._subscriptions.push(
              (0, M.combineLatest)([this.side$, this._baseCurrencyCryptoBalance$]).subscribe(
                (e) => {
                  const [t, i] = e
                  this._baseCurrencyCryptoBalanceValue$.next(
                    (0, q.getCryptoBalanceValue)({
                      side: t,
                      balance: i,
            ...
            null !== this._quoteCurrencyCryptoBalance$ &&
              this._subscriptions.push(
                (0, M.combineLatest)([this.side$, this._quoteCurrencyCryptoBalance$]).subscribe(
                  (e) => {
                    const [t, i] = e
          ...
          const e = (0, M.combineLatest)({
            ...
            t = (0, M.combineLatest)({
              ...
              const {
                ...
                l = (0, De.checkQtyError)(this.info.qty, t),
                u = (0, Qe.validateBalance)({
                  side: o,
                  baseValue: t,
                  baseBalanceValue: n,
        ...
        _calculateQuantityValues(e) {
          ...
          switch (t) {
            case 3:
              null !== s && (n = (0, Ce.Big)(s).mul(i).toNumber())
              break
            case 4:
              null !== r &&
                (o = (0, Ce.Big)(r)
          ...
          return {
            baseCurrencyQuantity: (0, q.applyRounding)(o, this.formatter),
            quoteCurrencyQuantity: (0, q.applyRounding)(n, this.formatter),
          }
        }
      }
      var We = i(759333)
      class je {
        constructor({
          ...
          ;((this.onControlFocused = new Q.Delegate()),
            ...
            (this.durationMetaInfoList =
              void 0 !== s ? (0, q.filterDurationsBySymbolDurations)(s, r) : []),
            (this.orderType$ = t))
          const l = this._getDurationByOrderType(e, a())
          ;((this.$value = new n.BehaviorSubject(l)),
            (this.currentDuration = new We.WatchedObject(l, j.comparator)),
            (this._currentDurationSubscription = (0, j.makeSubjectFromWatchedValue)(
              this.currentDuration,
            )),
            this._currentDurationSubscription.subject.pipe(h(this._stop$)).subscribe((e) => {
              this.$value.next(e)
            }),
            (this._orderTypeSubscription = this.orderType$.pipe(h(this._stop$)).subscribe((e) => {
        ...
        isDurationsAvailable() {
          return (
            null !== this._getDurationByOrderType(this.currentDuration.value(), this.getOrderType())
          )
        }
        unsubscribe() {
          ;(this._stop$.next(),
        ...
        _getDurationByOrderType(e, t) {
          const i = (0, q.filterDurationsByOrderType)(this.durationMetaInfoList, t)
          if (0 === i.length) return null
          return null !== e && i.some((t) => e.type === t.value)
            ? e
            : (0, q.makeInitialOrderDuration)(t, i)
        }
      }
      function Ue(e, t = 100, i) {
        const s = new Map(),
          r = new Map()
        return function (...o) {
          var n
      ...
      var Ge = i(61121)
      const He = (0, p.getLogger)('Trading.LeverageViewModel')
      class Ke {
        constructor({
          ...
          ;((this.onControlFocused = new Q.Delegate()),
            ...
            (this.setLeverage = async (e) => {
              try {
                ...
                throw (
                  He.logError(`Failed to set leverage: ${(0, y.getLoggerMessage)(e)}`),
                  new Error(b.t(null, void 0, i(252888)))
                )
              }
            }),
            (this.previewLeverage = async (e) => {
              try {
                ...
                throw (
                  ...
                  He.logError(`Failed to preview leverage: ${(0, y.getLoggerMessage)(e)}`),
                  new Error(b.t(null, void 0, i(48048)))
                )
              }
            }),
            ...
            (this._updateLeverageInfo = (0, Ge.respectLatest)(this._updateLeverageInfo)),
            ...
            (this.orderType = (0, r.ensureNotNull)(d())),
            (this.side = c),
            (this.blocked$ = _),
            (this.getBlocked = g),
            (this.onBlockedClick = v),
            (this.getLeverageInfo = Ue(this.getLeverageInfo)))
        }
        async getLeverageInfo(e) {
          try {
            return await this._adapterLeverageInfo(e)
          } catch (e) {
            return (He.logError(`Failed to get leverage info: ${(0, y.getLoggerMessage)(e)}`), null)
          }
        }
        subscribe() {
          this._subscription = (0, M.combineLatest)({
            orderType: this._orderType$,
            side: this._side$,
            customFieldsDependencies: J(this._customFieldsInputValues$, this.blocked$).pipe(
              (0, P.map)(([e, t]) => ({ customFields: e, blocked: t })),
            ),
          }).subscribe(({ orderType: e, side: t, customFieldsDependencies: i }) => {
            if (
      ...
      const Ye = ' ',
        Je = (e, t) =>
          b.t(null, void 0, i(733740)).format({ qty: e, symbol: t, whitespaceNoBreak: Ye }),
        Xe = (e, t, s) =>
          b
        ...
        Ze = (e, t, s) =>
          b
            ...
            .format({ qty: e, symbol: t, limitPrice: s, whitespaceNoBreak: Ye }),
        et = (e, t, s, r) =>
          b
            .t(null, void 0, i(991313))
            .format({ qty: e, symbol: t, stopPrice: s, limitPrice: r, whitespaceNoBreak: Ye }),
        [tt, it] = b.t(null, void 0, i(419676)).split(/{line_break}/)
      class st {
        constructor(e, t) {
          ;((this.getValue = () => this._value.getValue()),
            (this.subscribe = () => {
              const e = (0, r.ensureDefined)(this._props)
              if (e.existingOrder || this._tradingEntityType === L.TradingEntityType.Position)
                return
              const t = {
                status: e.status,
              ...
              this._orderSubscription = (0, M.combineLatest)(t).subscribe(
            ...
            (this._orderSubscriptionValues = (e) => {
              ...
              if (s === E.OrderPanelStatus.Preview)
                return this._value.next({ primaryText: b.t(null, void 0, i(454674)) })
              if (s === E.OrderPanelStatus.Wait)
                return n === E.OrderPlacingStatus.Placed
                  ? this._value.next({ primaryText: b.t(null, void 0, i(348649)) })
                  : this._value.next({ primaryText: tt, secondaryText: it })
              const h = null !== u ? t.formatter.format(u) : '',
                c = null !== d ? t.formatter.format(d) : '',
                p = null !== l ? t.quantityFormatter.format(l) : '',
                _ = 1 === a ? b.t(null, void 0, i(169961)) : b.t(null, void 0, i(168222))
              switch (o) {
                case 2:
                  return this._value.next({ primaryText: _, secondaryText: Je(p, t.symbol) })
                case 3:
                  return this._value.next({ primaryText: _, secondaryText: Xe(p, t.symbol, h) })
                case 1:
                  return this._value.next({ primaryText: _, secondaryText: Ze(p, t.symbol, c) })
                case 4:
                  return this._value.next({ primaryText: _, secondaryText: et(p, t.symbol, h, c) })
              }
            }),
        ...
        _setInitialValue() {
          var e, t
          const s =
            (null === (e = this._props) || void 0 === e ? void 0 : e.displayMode) ===
            E.OrderEditorDisplayMode.ResizableDrawer
              ? b.t(null, void 0, i(561874))
              : b.t(null, void 0, i(224522))
          switch (this._tradingEntityType) {
            case L.TradingEntityType.Order:
              const e =
                !0 === (null === (t = this._props) || void 0 === t ? void 0 : t.existingOrder)
                  ? s
                  : ''
              this._value.next({ primaryText: e })
              break
            case L.TradingEntityType.Position:
              this._value.next({ primaryText: b.t(null, void 0, i(561874)) })
          }
        }
      }
      i(150335)
      ...
      class nt {
        constructor({
          ...
          price$: r,
          side$: o,
          showTotalInsteadOfTradeValue: a,
          showRiskControlsAndInfo: l,
          info: u,
          tpInfo: d,
          slInfo: h,
          supportMargin: c,
          ...
          ;((this._infoTableData$ = new n.BehaviorSubject({ rows: [] })),
            ...
            (this._riskFormatter = new A.PriceFormatter({ priceScale: 100 })),
            ...
            (this._side$ = o),
            (this._type = u.type),
            (this._pipValueType$ = p),
            (this._currency = i),
            (this._marginRate = u.marginRate),
            (this._hasMarginMeter = c && (void 0 !== _ || void 0 !== this._marginRate)),
            (this._price$ = r),
            (this._showTotalInsteadOfTradeValue = a),
            (this._showRiskControlsAndInfo = l),
            (this._bigPointValue = u.bigPointValue || 1),
            (this._instrumentCurrency = u.currency),
            (this._leverageInfo$ = _),
            (this._leverage = u.leverage),
            (this._lotSize = u.lotSize),
            (this._symbolPipSize = u.pipSize),
            (this._pipValueForCurrentQuantity = 0),
            (this._tradeValueInSymbolCurrency = 0),
            (this._tradeValue = 0),
            (this._priceMagnifier = u.priceMagnifier),
            d &&
              h &&
              ((this._tpEnabled$ = d.enabled),
              (this._tpRiskInCurrency$ = d.riskInCurrency),
              (this._tpRiskInPercent$ = d.riskInPercent),
              (this._slEnabled$ = h.enabled),
              (this._slRiskInCurrency$ = h.riskInCurrency),
              (this._slRiskInPercent$ = h.riskInPercent)))
        }
        subscribe() {
          ;((this._subscriptions = [
            (0, M.combineLatest)({
              ...
              side: this._side$,
              qty: this._qty$,
              leverageInfo: void 0 !== this._leverageInfo$ ? this._leverageInfo$ : (0, w.of)(null),
              tpEnabled: null !== this._tpEnabled$ ? this._tpEnabled$ : (0, w.of)(null),
              tpRiskInCurrency:
                null !== this._tpRiskInCurrency$ ? this._tpRiskInCurrency$ : (0, w.of)(null),
              tpRiskInPercent:
                null !== this._tpRiskInPercent$ ? this._tpRiskInPercent$ : (0, w.of)(null),
              slEnabled: null !== this._slEnabled$ ? this._slEnabled$ : (0, w.of)(null),
              slRiskInCurrency:
                null !== this._slRiskInCurrency$ ? this._slRiskInCurrency$ : (0, w.of)(null),
              slRiskInPercent:
                null !== this._slRiskInPercent$ ? this._slRiskInPercent$ : (0, w.of)(null),
            })
              .pipe(ye(100, void 0, { trailing: !0, leading: !0 }))
              .subscribe((e) => {
                const {
                  price: t,
                  pipValue: i,
                ...
                if (
                  ...
                  (this._pipValueForCurrentQuantity = (0, j.convertToBaseMonetaryUnit)(
                    (0, j.calculatePipValue)(r, i, this._lotSize),
                    this._priceMagnifier,
                  )),
                  null === r)
                )
                  ...
                  const e =
                    'crypto' === this._type
                      ? (0, Ce.Big)(r).mul(t).toNumber()
                      : rt(r, t, i, this._symbolPipSize, this._lotSize)
                  this._tradeValue = (0, j.convertToBaseMonetaryUnit)(e, this._priceMagnifier)
                  const s = ot(r, t, this._bigPointValue, this._lotSize)
                  this._tradeValueInSymbolCurrency = (0, j.convertToBaseMonetaryUnit)(
                    s,
                    this._priceMagnifier,
                  )
                }
                ...
                ;(null === o && c.unshift(...this._makeLeverageInfo()),
                  this._usedMargin$.next((0, j.calculateUsedMargin)(this._tradeValue, p)),
        ...
        title() {
          return b.t(null, void 0, i(330569))
        }
        ...
        _getTradeValue() {
          ...
          if (this.hasTradeValue())
            return (0, j.formatInfoValue)(
              this._tradeValue * (null !== (e = this._getMarginRate()) && void 0 !== e ? e : 1),
            )
        }
        ...
        _makeLeverageInfo() {
          const e = (0, j.displayedLeverage)(this._leverage, this._marginRate)
          return null === e ? [] : [{ title: b.t(null, void 0, i(824813)), value: e }]
        }
        _makeLotSizeInfo() {
          return 'number' == typeof this._lotSize && Number.isFinite(this._lotSize)
            ? [{ title: b.t(null, void 0, i(574045)), value: String(this._lotSize) }]
            : []
        }
        _makePipValueInfo(e) {
          return this._showRiskControlsAndInfo &&
            e !== L.PipValueType.None &&
            Number.isFinite(this._pipValueForCurrentQuantity)
            ? [
                {
                  title:
                    e === L.PipValueType.Pips
                      ? b.t(null, void 0, i(207074))
                      : b.t(null, void 0, i(414285)),
                  value: `${(0, j.formatInfoValue)(this._pipValueForCurrentQuantity)} ${this._currency}`,
                },
              ]
            : []
        }
        _makeTradeValueInfo() {
          ...
          const t = this._showTotalInsteadOfTradeValue
              ? b.t(null, void 0, i(408007))
              : b.t(null, void 0, i(248410)),
          ...
          return void 0 === s
            ...
            : [
                { title: t },
                {
                  title: b.t(null, void 0, i(902456)),
                  value: `${e} ${this._currency}`,
                  listMarker: !0,
                },
                {
                  title: b.t(null, void 0, i(270743)),
        ...
        _getTradeValueInSymbolCurrency() {
          ...
          if (
            ...
            return (0, j.formatInfoValue)(this._tradeValueInSymbolCurrency * t)
        }
        _getMarginRate() {
          return null !== this._leverageInfo
            ? 0 !== this._leverageInfo.leverage
              ? (0, Ce.Big)(1).div(this._leverageInfo.leverage).toNumber()
              : void 0
        ...
        _makeRiskInfo(e, t, s) {
          return this._showRiskControlsAndInfo && e && null !== t && null !== s
            ? [
                {
                  title: b.t(null, void 0, i(663886)),
                  value: `${this._riskFormatter.format(s)}% (${this._riskFormatter.format(t)} ${this._currency})`,
                },
              ]
            : []
      ...
      const at = (0, p.getLogger)('PromiseWithDefault')
      function lt(e, t, i) {
        return e.catch((e) => (at.logError(e), i && i(), t))
      }
      const ut = {
        symbol: b.t(null, void 0, i(595481)),
        ask: b.t(null, void 0, i(535928)),
        bid: b.t(null, void 0, i(395506)),
        orderType: b.t(null, void 0, i(998413)),
        side: b.t(null, void 0, i(777630)),
        quantity: b.t(null, void 0, i(598721)),
        price: b.t(null, void 0, i(7953)),
        stopPrice: b.t(null, void 0, i(475299)),
        limitPrice: b.t(null, void 0, i(277646)),
        currency: b.t(null, void 0, i(381849)),
        stopLoss: b.t(null, void 0, i(719702)),
        takeProfit: b.t(null, void 0, i(255739)),
        buy: b.t(null, void 0, i(169961)),
        sell: b.t(null, void 0, i(168222)),
        warning: b.t(null, void 0, i(627822)),
      }
      class dt {
        constructor(e, t, i, s, r, o, a, l) {
          ;((this.warnings = []),
            ...
            this._fillOrderInfo(),
            (e.takeProfit || e.stopLoss) && this.warnings.push(ut.warning),
            t.warnings && this.warnings.push(...t.warnings),
            t.errors && this.errors.push(...t.errors),
            (this.infoTableQuotesData$ = this._infoTableQuotesData$.asObservable()))
        }
        subscribe() {
          return this._quotes$
            .pipe((0, ve.distinctUntilChanged)((e, t) => e.ask === t.ask && e.bid === t.bid))
        ...
        _fillQuotesInfo(e) {
          const t = [
            { title: ut.symbol, value: this.order.symbol },
            { title: ut.ask, value: e ? this._formatter.format(e.ask) : '' },
            { title: ut.bid, value: e ? this._formatter.format(e.bid) : '' },
          ]
          this._infoTableQuotesData$.next({ rows: t })
        }
        _fillOrderInfo() {
          ;(this._infoTableOrderData.rows.push(
            { title: ut.orderType, value: this.order.type ? E.orderTypes[this.order.type] : '' },
            {
              title: ut.side,
              value: 1 === this.order.side ? ut.buy : ut.sell,
              type: 1 === this.order.side ? 0 : 1,
            },
            { title: ut.quantity, value: this._quantityFormatter.format(this.order.qty) },
          ),
            ...
            4 === this.order.type &&
              this._infoTableOrderData.rows.push(
                { title: ut.stopPrice, value: this._formatter.format(this.order.stopPrice) },
                { title: ut.limitPrice, value: this._formatter.format(this.order.limitPrice) },
              ),
            this.order.stopLoss &&
              this._infoTableOrderData.rows.push({
                title: ut.stopLoss,
            ...
            this._currency.length > 0 &&
              this._infoTableOrderData.rows.push({ title: ut.currency, value: this._currency }))
        }
      }
      var ht = i(73359),
        ct = i(350146)
      const pt = _.enabled('order_panel_undock')
      function _t(e) {
        const {
            pin: t,
            mode$: s,
            ...
            supportBrackets: u,
            supportPlaceOrderPreview: d,
            supportModifyOrderPreview: h,
            isUndockAllowed: c,
            toggleSettings: p,
          } = e,
          _ = (e) => () => p(e),
          y = (e) => r.pipe((0, P.map)((t) => !!t[e])),
          g = []
        if (
          (c &&
            pt &&
            g.push({
              settingType: 1,
              onLabel: b.t(null, void 0, i(702733)),
              offLabel: b.t(null, void 0, i(442956)),
              dataName: 'dock-undock-order-panel-button',
              onIcon: ht,
              offIcon: ct,
              onClick: () => t(),
              value$: s.pipe((0, P.map)((e) => e === E.OrderEditorDisplayMode.Panel)),
            }),
          n &&
            g.push({
              settingType: 0,
              label: b.t(null, void 0, i(373447)),
          ...
          {
            const e = l ? b.t(null, void 0, i(973085)) : b.t(null, void 0, i(973353))
            g.push(
              {
                settingType: 0,
          ...
          if (u) {
            const e = b.t(null, void 0, i(271854))
            ;(0,
              g.push(
                {
                  settingType: 0,
      ...
      const yt = (0, p.getLogger)('Trading.OrderViewModel')
      class bt {
        constructor({
          adapter: e,
          order: t,
          ...
          qtySuggester: B,
          isVisible: D,
          orderDialogOptions: L,
          informerMessage$: R,
          warningMessage$: F,
          headerState: z,
          isOrderPresetsEnabled: W,
        }) {
          var U, G, H, K, Y
          if (
            ...
            (this._orderPlacingStatus = new n.BehaviorSubject(E.OrderPlacingStatus.Creating)),
            (this._destroyed = !1),
            ...
            (this.activateOrderTicket = () => {
              var e
              ;(this.setStatus(
                this.existingOrder ? E.OrderPanelStatus.Editing : E.OrderPanelStatus.Active,
              ),
                null === (e = this._orderTypeSubscription) || void 0 === e || e.unsubscribe(),
                this.sideModel &&
                ...
                this._orderPlacingStatus.next(E.OrderPlacingStatus.Creating))
            }),
            (this.setLoading = (e) => {
            ...
            (this._doneButtonClick = async () => {
              ...
              if (
                ...
                try {
                  ...
                  ;((this.orderPreviewModel = new dt(
                    ...
                    this.setStatus(E.OrderPanelStatus.Preview))
                } catch (e) {
                  ;(this._isFullscreenPopup() && this.headerModel.close(),
                    this._showErrorNotification(
                      b.t(null, void 0, i(204395)),
                      (0, y.getErrorMessage)(e),
                    ))
                }
                return
              }
              const t = await this._doneHandler(
                  e,
              ...
              ;(t
                ? (this.onDoneButtonClicked.resolve(!0),
                  s === E.OrderEditorDisplayMode.Popup ||
                  s === E.OrderEditorDisplayMode.ResizableDrawer
                    ? this.headerModel.close()
                    : this._cancel(),
                  this.existingOrder || this._orderPlacingStatus.next(E.OrderPlacingStatus.Placed))
                : (this._isFullscreenPopup() && this.headerModel.close(),
                  s === E.OrderEditorDisplayMode.Panel &&
                    null !== this.orderPreviewModel &&
            ...
            (this._handleStatusChange = (e) => {
              const t =
                e !== E.OrderPanelStatus.Preview && this._isTradable
            ...
            (this._mergeInputStateDiff = (e) => {
              ;(void 0 !== e.duration && (this._currentInputState.duration = null),
                (0, v.default)(this._currentInputState, e))
            }),
            (this._back = () => {
            ...
            (this._isOrderPresetsEnabled = W),
            (this._isTradable = r.tradable),
            (this._headerState = z),
            (this.headerStateValue = z),
            this._headerState.setSettings(void 0),
            (this._displayMode$ = d),
            (this._getDisplayMode = h),
            (this._toggleTradingWidget = p),
            (this._toggleTradingPanelPopup = _),
            (this._toggleMode = P),
            (this._toggleSettings = w),
            (this._getSettings = V),
            (this._onNeedSelectBroker = u),
            (this._showErrorNotification = C),
            (this._trackEvent = c),
            (this._orderWidgetStat = a),
            (this._pipValueType$ = l),
            (this._qtySuggester = B),
            (this._informerMessage$ = R),
            (this._settings$ = s),
            ...
            (this._stopLossAvailable$ = new n.BehaviorSubject(
              Boolean(
                null !==
                  (G = null !== (U = t.trailingStopPips) && void 0 !== U ? U : t.guaranteedStop) &&
                  void 0 !== G
                  ? G
                  : t.stopLoss,
              ),
          ...
          if (((this._adapter = e), (this.brokerName = e.metainfo().title), !r.tradable))
            return void (this.onReady = this._prepareTradableSolution(r))
          ;((this._sendHandler = $),
            (this._previewHandler = M),
            (this.existingOrder = t.hasOwnProperty('id')),
            this.setStatus(
              this.existingOrder ? E.OrderPanelStatus.Editing : E.OrderPanelStatus.Active,
            ))
          const J = e.metainfo().configFlags
          ;((this.supportModifyOrderPrice = J.supportModifyOrderPrice),
            (this.supportModifyQuantity =
              !this.existingOrder || Boolean(this.existingOrder && J.supportEditAmount)),
            (this.showQuantityInsteadOfAmount = J.showQuantityInsteadOfAmount),
            (this.supportModifyDuration = J.supportModifyDuration),
            (this.supportLeverage = J.supportLeverage),
            (this.supportLeverageButton = J.supportLeverage && J.supportLeverageButton),
            (this.supportPlaceOrderPreview = J.supportPlaceOrderPreview),
            (this.supportModifyOrderPreview = J.supportModifyOrderPreview),
            (this.supportBalances = J.supportBalances),
            (this.supportCryptoBrackets = J.supportCryptoBrackets),
            (this.supportStopOrdersInBothDirections = J.supportStopOrdersInBothDirections),
            (this.supportStopLimitOrdersInBothDirections =
              J.supportStopLimitOrdersInBothDirections),
            (this.supportStrictCheckingLimitOrderPrice = J.supportStrictCheckingLimitOrderPrice),
            (this.supportCurrencyInOrderPreview = J.supportCurrencyInOrderPreview),
            (this.supportModifyOrderType = J.supportModifyOrderType),
            this._orderType$.next(
              null !==
                (Y =
                  null !==
                    (K =
                      null !== (H = t.type) && void 0 !== H
                        ? H
                        : null == I
                          ? void 0
                          : I.orderType) && void 0 !== K
                    ? K
                    : (0, q.getDefaultOrderType)(J)) && void 0 !== Y
                ? Y
                : null,
            ),
            (this.onReady = Promise.all([
              ...
              lt(e.accountMetainfo(), { id: e.currentAccount(), name: e.metainfo().title }),
              lt(e.quotesSnapshot(t.symbol), {}, this._noQuotesCallback),
              lt(e.formatter(t.symbol, !1), new A.PriceFormatter()),
              lt(e.spreadFormatter(t.symbol), new A.PriceFormatter()),
            ])
              .then(async ([i, s, o, n, a, l]) => {
                if (
                  ((this._isBats = (0, q.isBatsQuotes)(n)),
                  (this._supportCryptoExchangeOrderTicket =
                    J.supportCryptoExchangeOrderTicket ||
                    (J.supportSymbolSpecificCryptoOrderTicket && 'crypto' === i.type)),
                  (this._symbolInfo = i),
                  this._destroyed)
                )
                  return
                ;((this._supportMarketOrders =
                  J.supportMarketOrders &&
                  (0, q.isOrderTypeAllowed)(2, null == s ? void 0 : s.allowedOrderTypes)),
                  (this._supportLimitOrders =
                    J.supportLimitOrders &&
                    (0, q.isOrderTypeAllowed)(1, null == s ? void 0 : s.allowedOrderTypes)),
                  (this._supportStopOrders =
                    J.supportStopOrders &&
                    (0, q.isOrderTypeAllowed)(3, null == s ? void 0 : s.allowedOrderTypes)),
                  (this._supportStopLimitOrders =
                    J.supportStopLimitOrders &&
                    (0, q.isOrderTypeAllowed)(4, null == s ? void 0 : s.allowedOrderTypes)),
                  (this._supportBrackets =
                    (null == s ? void 0 : s.supportOrderBrackets) &&
                    !(t.hasOwnProperty('parentId') && t.parentId)),
                  (this._supportModifyBrackets = this._supportBrackets && J.supportModifyBrackets),
                  (this._supportAddBracketsToExistingOrder =
                    this._supportModifyBrackets && J.supportAddBracketsToExistingOrder),
                  (this._supportTrailingStop = this._supportBrackets && J.supportTrailingStop),
                  (this._supportGuaranteedStop = this._supportBrackets && J.supportGuaranteedStop),
                  (this._supportMarketBrackets = this._supportBrackets && J.supportMarketBrackets),
                  (this._supportModifyTrailingStop =
                    this._supportTrailingStop &&
                    this._supportModifyBrackets &&
                    J.supportModifyTrailingStop),
                  (this.displaySymbolName = this._getCurrentSymbolName()),
                  (this.symbolType = i.type),
                  (this.symbolSpecificWarningMessage = null == s ? void 0 : s.warningMessage),
                  (this.currency = (0, q.getCurrency)(o)),
                  (this._currencyName = (0, q.getCurrency)(o, !0)),
                  (this.formatter = a),
                  (this.symbolHasLotSize = i.hasOwnProperty('lotSize')),
                  (this.showRiskControlsAndInfo = J.supportRiskControlsAndInfo && 0 !== i.pipValue),
                  (this._suggestedQty = await this._qtySuggester.getQty(this.symbol)),
                  (this._initialInputState = this._getInitialInputState(t, i, I, s)),
                  (this._currentInputState = Object.assign({}, this._initialInputState)))
                const u = i.variableMinTick
                  ? (0, N.makeVariableMinTickData)(i.minTick, i.variableMinTick)
                  : void 0
                ;((this._quotes$ = (0, k.fromEventPattern)(
                  (i) => e.subscribeRealtime(t.symbol, i),
                  (i) => e.unsubscribeRealtime(t.symbol, i),
                  (e, t) => (0, j.alignQuotesToMinTick)(t, i.minTick, u),
                ).pipe(
                  (0, m.startWith)(n),
                  (0, f.share)({ connector: () => new S.ReplaySubject(1) }),
                )),
                  (this._equity$ = (0, k.fromEventPattern)(
                  ...
                  (this._marginAvailable$ = J.supportMargin
                    ? T(
                    ...
                    : null),
                  (this._baseCurrencyCryptoBalance$ = J.supportBalances
                    ? T(
                        (0, k.fromEventPattern)(
                    ...
                    : null),
                  (this._quoteCurrencyCryptoBalance$ = J.supportBalances
                    ? T(
                        (0, k.fromEventPattern)(
                  ...
                  (this._pipValues$ = T(
                    (0, k.fromEventPattern)(
                      ...
                      (e, t) => t,
                    ).pipe((0, m.startWith)({ buyPipValue: i.pipValue, sellPipValue: i.pipValue })),
                  )),
                  void 0 === this._orderTemplate.limitPrice &&
                    !1 === this.existingOrder &&
                    (this._orderTemplate.limitPrice =
                      1 === this._initialInputState.side ? (0, q.getAsk)(n) : (0, q.getBid)(n)),
                  void 0 === this._orderTemplate.stopPrice &&
                    !1 === this.existingOrder &&
                    (this._orderTemplate.stopPrice =
                      1 === this._initialInputState.side ? (0, q.getBid)(n) : (0, q.getAsk)(n)),
                  this._createModels({
                    order: t,
                    info: i,
                    spreadFormatter: l,
                    isTradable: r.tradable,
              ...
              .catch((e) => {
                throw (yt.logError('Failed to create order model: ' + e), e)
              })))
        }
        destroy() {
          var e
          ;((this._destroyed = !0),
            ...
            this.quantityConverterController && this.quantityConverterController.destroy(),
            this.quantityModel &&
            ...
            void 0 !== this.leverageModel &&
              ...
              this.leverageModel.onControlFocused.unsubscribe(this, this.activateOrderTicket)),
            void 0 !== this.customFieldsModel && this.customFieldsModel.unsubscribe(),
        ...
        deactivateOrderTicket() {
          this.getStatus() !== E.OrderPanelStatus.Wait &&
            (this._resetBracketsFocus(),
            this.setStatus(E.OrderPanelStatus.Wait),
            ...
            this._onFocusSubscriptions.push(
              this.customFieldsModel.onControlFocused$.subscribe(this.activateOrderTicket),
            ),
        ...
        preOrder() {
          ...
          const o = {
            symbol: this.symbol,
            type: (0, r.ensureNotNull)(this._orderType$.value, 'Make pre-order: Order type value'),
          ...
          4 === this._orderType$.value
            ? ((o.stopPrice =
                null !== (e = this.stopPriceModel.getValue()) && void 0 !== e ? e : void 0),
              (o.limitPrice =
                null !== (t = this.limitPriceModel.getValue()) && void 0 !== t ? t : void 0))
            : 3 === this._orderType$.value
              ? (o.stopPrice =
                  null !== (i = this.stopPriceModel.getValue()) && void 0 !== i ? i : void 0)
              : 1 === this._orderType$.value &&
                (o.limitPrice =
                  null !== (s = this.limitPriceModel.getValue()) && void 0 !== s ? s : void 0)
          const n = this.durationModel.getValue()
          return (
            null !== n && (o.duration = n),
            this.stopLossModel &&
              (this.stopLossModel.getBracketType() === L.BracketType.StopLoss &&
                ...
                (o.guaranteedStop = void 0),
                (o.stopType = D.StopType.StopLoss)),
              this.stopLossModel.getBracketType() === L.BracketType.TrailingStop &&
                ((o.trailingStopPips = this.stopLossModel.getEnabled()
                  ...
                  : void 0),
                (o.stopLoss = void 0 !== o.trailingStopPips ? void 0 : o.stopLoss),
                (o.guaranteedStop = void 0),
                (o.stopType = D.StopType.TrailingStop)),
              this.stopLossModel.getBracketType() === L.BracketType.GuaranteedStop &&
                ((o.guaranteedStop = this.stopLossModel.getEnabled()
                  ? (0, r.ensureNotNull)(
                      this.stopLossModel.price.getValue(),
                      'Make pre-order: StopLoss Model price value',
                    )
                  : void 0),
                (o.stopLoss = void 0 !== o.guaranteedStop ? void 0 : o.stopLoss),
                (o.trailingStopPips = void 0),
                (o.stopType = D.StopType.GuaranteedStop))),
            this.takeProfitModel &&
            ...
            this.customFieldsModel.getCustomFieldsModels() &&
              (o.customFields = this.customFieldsModel.getCustomFieldsInputValues()),
            o
          )
        }
        getStatus() {
        ...
        _isFullscreenPopup() {
          return (
            ...
            this._getDisplayMode() === E.OrderEditorDisplayMode.Popup
          )
        }
        _createSimpleDialog(e) {
          ...
          ;(this._orderType$.next(null),
            ...
            (this.headerModel = new se({
              ...
              brokerId: null === (t = this._adapter) || void 0 === t ? void 0 : t.metainfo().id,
            })),
        ...
        _createModels(e) {
          ...
          const {
              ...
              spreadFormatter: d,
              isTradable: h,
              symbolSpecificTradingOptions: c,
              forceAbsolutePriceUpdate: p,
              orderDialogOptions: _,
            } = e,
            y = this.supportCryptoExchangeOrderTicket()
          ;((this.sideModel = new be({
            initialSide: this._initialInputState.side,
            quotes$: this._quotes$,
            priceFormatter: this.formatter,
            spreadFormatter: d,
            baseCurrency: (y && 'crypto' === u.type && u.baseCurrency) || null,
          })),
            (this._pipValue$ = (0, M.combineLatest)([this._pipValues$, this.sideModel.value$]).pipe(
              (0, P.map)(([e, t]) => (1 === t ? e.buyPipValue : e.sellPipValue)),
            )))
          const { orderRules: b = [], title: g } = this._adapter.metainfo()
          let v = [],
            k = []
          ;((this.supportStopOrdersInBothDirections &&
            this.supportStopLimitOrdersInBothDirections) ||
            ((v =
              null !== (t = (0, R.extractLimitValidationRules)(this._adapter, this.symbol)) &&
              void 0 !== t
                ? t
                : []),
            (k =
              null !== (i = (0, R.extractStopValidationRules)(this._adapter, this.symbol)) &&
              void 0 !== i
                ? i
                : [])),
            (this.stopPriceModel = new Se({
              priceType: 2,
              quotes$: this._quotes$,
            ...
            (this.limitPriceModel = new Se({
              ...
              supportStrictCheckingLimitOrderPrice: this.supportStrictCheckingLimitOrderPrice,
            })),
            (this.priceGroupModel = new Me({
            ...
            (this.quantityModel = y
              ? new Ne({
                  ...
                  orderQty: l.qty,
                  orderPrice: 1 === l.type ? l.limitPrice : l.stopPrice,
                })
              : new xe({
                  ...
                  pipValue$: this._pipValue$,
                  info: u,
                  currency: null !== (s = this.currency) && void 0 !== s ? s : '',
                  initialQty: this._initialInputState.quantity,
                  initialOrderSizeCalculatorValue: this._initialInputState.orderSizeCalculatorValue,
                  initialOrderSizeCalculatorQuantityType:
                    this._initialInputState.orderSizeCalculatorQuantityType,
                  initialLastRiskQuantityType: this._initialInputState.lastRiskQuantityType,
                  initialLastUsedQuantityType: this._initialInputState.lastUsedQuantityType,
                  stopLossAvailableGetter: () => this._stopLossAvailable$.getValue(),
                  settings$: this._settings$,
                  orderWidgetStat: this._orderWidgetStat,
          ...
          ;((m || this.supportCryptoBrackets) &&
            this._createBracketsModels(l, u, (0, r.ensureDefined)(this.currency)),
            (this.headerModel = new se({
              displaySymbolName: this.displaySymbolName,
              symbol: this.symbol,
              ...
              headerState: this._headerState,
              isOrderPresetsEnabled: this._isOrderPresetsEnabled,
              brokerId: null === (o = this._adapter) || void 0 === o ? void 0 : o.metainfo().id,
            })),
            (this.customFieldsModel = new W.CustomFieldsViewModel({
              existingOrder: this.existingOrder,
              initialInputState:
                null !== (n = this._initialInputState.customFields) && void 0 !== n ? n : void 0,
              customFields: null == _ ? void 0 : _.customFields,
              orderType$: this.orderType$,
            })),
            this.supportLeverage &&
              (this.leverageModel = new Ke({
                ...
                customFieldsInputValues$: this.customFieldsModel.customFieldsInputValues$,
                blocked$: this.customFieldsModel.isCustomFieldsNotSelected$,
                isBlockedGetter: () => this.customFieldsModel.getIsCustomFieldsNotSelected(),
                onBlockedClick: () =>
                  this.customFieldsModel.setIsEmptyRequiredCustomFieldsHighlighted(!0),
                getOrderType: this.getOrderType,
              })),
            y ||
              (this.orderInfoModel = new nt({
                ...
                price$: this.priceGroupModel.price$,
                side$: this.sideModel.value$,
                showTotalInsteadOfTradeValue: (0, j.shouldShowTotal)(_),
                showRiskControlsAndInfo: this.showRiskControlsAndInfo,
                info: u,
                tpInfo:
                ...
                pipValueType$: this._pipValueType$,
                leverageInfo$:
                  null === (a = this.leverageModel) || void 0 === a ? void 0 : a.leverageInfo$,
              })),
            (this.durationModel = new je({
              initialDuration: this._initialInputState.duration,
              orderType$: this.orderType$,
              orderWidgetStat: this._orderWidgetStat,
              orderDurations: this._adapter.metainfo().durations,
              symbolDurations: null == c ? void 0 : c.allowedDurations,
              getOrderType: this.getOrderType,
            })))
          const f = {
            orderType: this.orderType$,
          ...
          this.buttonModel = new st(L.TradingEntityType.Order, f)
        }
        _getUnitsTitle() {
          return this._symbolInfo.units
            ? this._symbolInfo.units
            : this.symbolHasLotSize
              ? b.t(null, void 0, i(833526))
              : 'stock' === this._symbolInfo.type
                ? b.t(null, void 0, i(288368))
                : b.t(null, void 0, i(715432))
        }
        ...
        _resetBracketsFocus() {
          var e, t
          ;(null === (e = this.takeProfitModel) || void 0 === e || e.setFocusedControl(0),
            null === (t = this.stopLossModel) || void 0 === t || t.setFocusedControl(0))
        }
        _createBracketsModels(e, t, i) {
          const s = {
              [L.BracketType.TakeProfit]: (0, R.extractTakeProfitValidationRules)(
                this._adapter,
                this.symbol,
              ),
              [L.BracketType.StopLoss]: (0, R.extractStopLossValidationRules)(
                this._adapter,
                this.symbol,
              ),
              [L.BracketType.GuaranteedStop]: (0, R.extractGuaranteedStopValidationRules)(
                this._adapter,
                this.symbol,
              ),
              [L.BracketType.TrailingStop]: (0, R.extractStopLossValidationRules)(
                this._adapter,
                this.symbol,
              ),
            },
          ...
          this.takeProfitModel = new ie({
            initialPrice: e.takeProfit || null,
            initialEnabled: Boolean(e.takeProfit),
            initialBracketType: L.BracketType.TakeProfit,
            formatter: this.formatter,
            equity$: this._equity$,
            quotes$: this._quotes$,
            info: t,
          ...
          const { makeInitialPrice: a, makeInitialEnabled: l, makeInitialBracketType: u } = ee,
            d = e.stopLoss,
            h = e.trailingStopPips,
            c = e.guaranteedStop,
            p = Boolean(h),
            _ = u({ stopLoss: d, trailingStopPips: h, guaranteedStop: c, stopType: e.stopType })
          this.stopLossModel = new ie({
            initialPrice: a({ stopLoss: d, trailingStopPips: h, guaranteedStop: c }),
            initialEnabled: l({ stopLoss: d, trailingStopPips: h, guaranteedStop: c }),
            initialBracketType: _,
            formatter: this.formatter,
            equity$: this._equity$,
            quotes$: this._quotes$,
            info: t,
            ...
            currency: i,
            parentType: 1,
            savedPips: (p ? e.trailingStopPips : this._currentInputState.stopLossPips) || null,
            settings$: this._settings$,
            orderWidgetStat: this._orderWidgetStat,
            showRiskControlsAndInfo: this.showRiskControlsAndInfo,
            status: this.getStatus(),
        ...
        _subscribe() {
          var e, t, i, s, r, o, n, a, l, u, d, h, p, _, y, b
          this._getDisplayMode() === E.OrderEditorDisplayMode.Popup &&
            this.getStatus() !== E.OrderPanelStatus.Preview &&
            this.activateOrderTicket()
          const g = this.status$.subscribe(this._handleStatusChange)
          ...
          const v = (0, M.combineLatest)({
            ...
            quotes: this._quotes$,
            limitPrice: this.limitPriceModel.value$,
            hasLimitPriceError: (0, w.of)(!1),
            stopPrice: this.stopPriceModel.value$,
            hasStopPriceError: (0, w.of)(!1),
            hasStopLossError: (0, w.of)(!1),
            hasTakeProfitError: (0, w.of)(!1),
            quantity: this.quantityModel.value$,
            hasQuantityError: (0, w.of)(!1),
            orderSizeCalculatorQuantityType:
              this.quantityModel instanceof xe
            ...
            takeProfitPrice:
              null !==
                (s =
                  null === (i = this.takeProfitModel) || void 0 === i ? void 0 : i.price.value$) &&
              void 0 !== s
                ? s
                : (0, w.of)(null),
            stopLossPips:
              null !==
                (o = null === (r = this.stopLossModel) || void 0 === r ? void 0 : r.value$) &&
              void 0 !== o
                ? o
                : (0, w.of)(null),
            stopLossPrice:
              null !==
                (a = null === (n = this.stopLossModel) || void 0 === n ? void 0 : n.price.value$) &&
              void 0 !== a
                ? a
                : (0, w.of)(null),
            takeProfitEnabled:
              null !==
                (u = null === (l = this.takeProfitModel) || void 0 === l ? void 0 : l.enabled$) &&
              void 0 !== u
                ? u
                : (0, w.of)(!1),
            stopLossEnabled:
              null !==
                (h = null === (d = this.stopLossModel) || void 0 === d ? void 0 : d.enabled$) &&
              void 0 !== h
                ? h
                : (0, w.of)(!1),
            ...
            bracketType:
              null !==
                (_ = null === (p = this.stopLossModel) || void 0 === p ? void 0 : p.bracketType$) &&
              void 0 !== _
                ? _
                : (0, w.of)(null),
          }).subscribe((e) => {
            const {
              ...
              hasStopPriceError: u,
              hasStopLossError: d,
              hasTakeProfitError: h,
              quantity: c,
              hasQuantityError: p,
              orderSizeCalculatorQuantityType: _,
              orderSizeCalculatorValue: y,
              lastRiskQuantityType: b,
              lastUsedQuantityType: g,
              takeProfitPips: v,
              takeProfitPrice: P,
              stopLossPips: k,
              stopLossPrice: m,
            ...
            ;(this._setDisabledIfNeeded({
              ...
              hasStopLossError: d,
              hasTakeProfitError: h,
              isTakeProfitIncorrect: f && null === v,
              isStopLossIncorrect: S && null === k,
              customFields: $,
              hasDurationError: T,
              hasLimitPriceError: a,
              hasStopPriceError: u,
          ...
          this._waitQuotesTimeout = setTimeout(() => this._isNoQuotes$.next(!0), 5e3)
          const P = (0, M.combineLatest)([this._quotes$, this.sideModel.value$]).subscribe(
              ([e, t]) => {
                const i = 1 === t ? (0, q.getAsk)(e) : (0, q.getBid)(e)
                ;((this._initialInputState.limitPrice = i), (this._initialInputState.stopPrice = i))
              },
            ),
            k = this._quotes$.subscribe((e) => {
              ;(this._isNoQuotes$.next((0, q.isNoQuotes)(e)), clearTimeout(this._waitQuotesTimeout))
            })
          if (
            ((this._subscriptions = [
            ...
            if (!this.supportCryptoExchangeOrderTicket()) {
              const e = (0, M.combineLatest)({
                ...
                i = (0, M.combineLatest)({
                  ...
                  .pipe(B(this.stopLossModel.focusedControl$))
                  .subscribe(([e, t]) => {
                    var i
                    const { quantityControl: s, orderSizeCalculatorQuantityType: r } = e
                    this._shouldChangeControlFocus(t, s, r) &&
                      (null === (i = this.stopLossModel) || void 0 === i || i.setFocusedControl(0))
                  })
          ...
          if (void 0 !== this.takeProfitModel && void 0 !== this.stopLossModel) {
            const e = (0, M.combineLatest)([
              ...
              this._rewardRisk$.next((0, j.formatRiskReward)(e, t))
            })
            this._subscriptions.push(e)
          }
          ;(this._subscriptions.push(g, v, P, k, this._pipValues$.connect()),
        ...
        async _getAndSendStatistics(e) {
          var t, i
          const s = this._isBracketStopTypeEnabled(L.BracketType.StopLoss),
            o = this.takeProfitModel && this.takeProfitModel.getEnabled(),
            n =
              this._supportTrailingStop &&
              this._isBracketStopTypeEnabled(L.BracketType.TrailingStop),
            a =
              this._supportGuaranteedStop &&
              this._isBracketStopTypeEnabled(L.BracketType.GuaranteedStop),
            l = 1 === e.side ? 'Buy' : 'Sell',
            u = ['Price', 'Pips'],
            d = [
              'Units',
            ...
            h = this.quantityModel.getFocusedControl(),
            c = ['Pips', 'Price', 'RiskInCurrency', 'RiskInPercent'],
            p = ['Limit', 'Market', 'Stop', 'StopLimit'][e.type - 1],
            _ = this.durationModel.getValue(),
            y = this.leverageModel ? this.leverageModel.leverageInfo() : null,
            b = 4 === e.type,
            g = 3 === e.type || b,
            v = 1 === e.type || b,
            P = Object.assign({}, this._getSettings()),
            k =
          ...
          ;((P.showRelativePriceControl = P.showRelativePriceControl && k),
            (P.showCurrencyRiskInQty = P.showCurrencyRiskInQty && m),
            (P.showPercentRiskInQty = P.showPercentRiskInQty && m),
            (P.showBracketsInCurrency = P.showBracketsInCurrency && m),
            (P.showBracketsInPercent = P.showBracketsInPercent && m),
            (P.showOrderPreview =
              P.showOrderPreview &&
            ...
            null !== this._orderWidgetStat &&
              (this._orderWidgetStat.setStaticSnowplowEventDataProperty({
                ...
                source: null !== (t = this._orderTemplate.source) && void 0 !== t ? t : null,
                side: l,
                orderType: p,
                leverageInfo: y,
                symbolType: void 0 !== this._symbolInfo.type ? this._symbolInfo.type : null,
                operation: this.existingOrder ? 'Modify' : 'Place',
                stopLoss: s ? (0, r.ensureDefined)(this.stopLossModel).getValue() : null,
                takeProfit: o ? (0, r.ensureDefined)(this.takeProfitModel).getValue() : null,
                trailingStop: n ? (0, r.ensureDefined)(this.stopLossModel).getValue() : null,
                guaranteedStop: a ? (0, r.ensureDefined)(this.stopLossModel).getValue() : null,
                focusedTPField: o
                  ? f((0, r.ensureDefined)(this.takeProfitModel).getFocusedControl(), c)
                  : null,
                focusedSLField: s
                  ? f((0, r.ensureDefined)(this.stopLossModel).getFocusedControl(), c)
                  : null,
                focusedQtyField: null !== (i = d[null !== h ? h : 0]) && void 0 !== i ? i : null,
                focusedLimitPriceField:
                  v || (b && this.limitPriceModel)
                    ? f(this.limitPriceModel.getFocusedControl(), u)
                    : null,
                focusedStopPriceField:
                  g && this.stopPriceModel ? u[this.stopPriceModel.getFocusedControl()] : null,
                duration: null !== _ ? _.type : null,
                isDefaultDuration: null !== _ ? _.type === this._getDefaultDuration().value : null,
                showBracketsInCurrency: P.showBracketsInCurrency,
                showBracketsInPercent: P.showBracketsInPercent,
                showCurrencyRiskInQty: P.showCurrencyRiskInQty,
                showOrderPreview: P.showOrderPreview,
                showPercentRiskInQty: P.showPercentRiskInQty,
                showRelativePriceControl: P.showRelativePriceControl,
              }),
        ...
        _getInitialInputState(e, t, i, s) {
          var r, o, n, a, l, u, d, h, c, p
          const _ = void 0 !== e.customFields ? { ...e.customFields } : void 0
          return {
            symbol: this.symbol,
            orderType: this._orderType$.value,
            side:
              null !==
                (o = null !== (r = e.side) && void 0 !== r ? r : null == i ? void 0 : i.side) &&
              void 0 !== o
                ? o
                : 1,
            limitPrice: e.limitPrice || e.price || e.stopPrice || null,
            stopPrice: e.stopPrice || e.price || e.limitPrice || null,
            quantity: e.qty || this._suggestedQty || (null == i ? void 0 : i.quantity) || t.qty.min,
            orderSizeCalculatorQuantityType:
              null !== (n = null == i ? void 0 : i.orderSizeCalculatorQuantityType) && void 0 !== n
                ? n
                : null,
            lastRiskQuantityType:
              null !== (a = null == i ? void 0 : i.lastRiskQuantityType) && void 0 !== a
                ? a
                : 'riskInPercent',
            lastUsedQuantityType:
              null !== (l = null == i ? void 0 : i.lastUsedQuantityType) && void 0 !== l
                ? l
                : 'units',
            orderSizeCalculatorValue:
              null !== (u = null == i ? void 0 : i.orderSizeCalculatorValue) && void 0 !== u
                ? u
                : null,
            takeProfitPips:
              null !== (d = null == i ? void 0 : i.takeProfitPips) && void 0 !== d
                ? d
                : E.BracketDefaultPips.TakeProfit,
            takeProfitPrice: null,
            stopLossPips:
              null !== (h = null == i ? void 0 : i.stopLossPips) && void 0 !== h
                ? h
                : E.BracketDefaultPips.StopLoss,
            stopLossPrice: null,
            customFields:
              null !== (c = null != _ ? _ : null == i ? void 0 : i.customFields) && void 0 !== c
                ? c
                : {},
            bracketType: null,
            duration: (0, q.getOrderDuration)({
              orderDuration: e.duration,
              orderType: this._orderType$.value,
              savedDuration:
                null !== (p = null == i ? void 0 : i.duration) && void 0 !== p ? p : null,
              orderDurations: this._adapter.metainfo().durations,
        ...
        _compareInputStates(e) {
          ...
          ;(t !== this._currentInputState.orderType && (g.orderType = t), v && (g.limitPrice = s))
          let P = null !== r
          if (null !== r) {
          ...
          ;(P && (g.stopPrice = r),
            null !== o && this._currentInputState.quantity !== o && (g.quantity = o),
            this._currentInputState.orderSizeCalculatorQuantityType !== n &&
              (g.orderSizeCalculatorQuantityType = n),
            this._currentInputState.lastRiskQuantityType !== a && (g.lastRiskQuantityType = a),
            this._currentInputState.lastUsedQuantityType !== l && (g.lastUsedQuantityType = l),
            this._currentInputState.orderSizeCalculatorValue !== u &&
              (g.orderSizeCalculatorValue = u),
            this._currentInputState.takeProfitPips !== d && (g.takeProfitPips = d),
            this._currentInputState.takeProfitPrice !== h && (g.takeProfitPrice = h),
            this._currentInputState.stopLossPips !== c && (g.stopLossPips = c),
            this._currentInputState.stopLossPrice !== p && (g.stopLossPrice = p),
            null === _ ||
              ...
              (g.duration = _),
            null !== i && this._currentInputState.side !== i && (g.side = i),
            null !== t && this._currentInputState.orderType !== t && (g.orderType = t),
            this._currentInputState.symbol !== this.symbol && (g.symbol = this.symbol),
            0 === Object.keys(y).length ||
              (0, z.deepEquals)(this._currentInputState.customFields, y)[0] ||
              (g.customFields = y),
            b !== this._currentInputState.bracketType && (g.bracketType = b),
            0 !== Object.keys(g).length && this._onInputStateChanged.fire(g))
        }
        _getCurrentInputState() {
          ...
          return {
            ...
            takeProfitPrice: this.takeProfitModel ? this.takeProfitModel.price.getValue() : null,
            stopLossPips: this.stopLossModel ? this.stopLossModel.pips.getValue() : null,
            stopLossPrice: this.stopLossModel ? this.stopLossModel.price.getValue() : null,
            duration: this.durationModel.getValue(),
            customFields: this.customFieldsModel.getCustomFieldsInputValues(),
            bracketType:
              null !==
                (t =
                  null === (e = this.stopLossModel) || void 0 === e
                    ? void 0
                    : e.getBracketType()) && void 0 !== t
                ? t
                : null,
          }
        }
        _setDisabledIfNeeded({
          ...
          customFields: u,
          hasDurationError: d,
          hasLimitPriceError: h,
          hasStopPriceError: c,
          hasQuantityError: p,
          hasStopLossError: _,
          hasTakeProfitError: y,
        }) {
          this._isButtonDisabled$.next(
            (this._getDisplayMode() === E.OrderEditorDisplayMode.Panel &&
              e === E.OrderPanelStatus.Wait) ||
              t ||
              (0, q.isNoQuotes)(i) ||
              null === s ||
              (0, j.checkPriceByOrderType)(this._orderType$.value, r, o) ||
              null === n ||
              _ ||
              y ||
              a ||
              ...
              this.customFieldsModel.getCustomFieldsModels().some((e) => !e.isValid()),
          )
        }
        _closeWidget() {
        ...
        async _prepareTradableSolution(e) {
          ;((this.tradableSolution = await (0, j.prepareTradableSolution)(e, this._adapter)),
        ...
        _calculateSeenPrice() {
          ...
          return null !== (e = 1 === this.sideModel.getValue() ? t.ask : t.bid) && void 0 !== e
            ? e
            : 0
        }
        _getCurrentQuotes() {
          const e = this.sideModel.currentQuotes()
          if (void 0 !== e.ask && void 0 !== e.bid) return { ask: e.ask, bid: e.bid }
        }
        _shouldChangeControlFocus(e, t, i) {
          return (
            (2 === e || 3 === e) &&
            ((5 === t && null !== i && ('riskInCurrency' === i || 'riskInPercent' === i)) ||
              1 === t ||
              2 === t)
          )
        }
        _getCurrentSymbolName() {
          ...
          return null !==
            (i =
              null !==
                (t = null === (e = this._symbolInfo) || void 0 === e ? void 0 : e.brokerSymbol) &&
              void 0 !== t
                ? t
                : 'brokerSymbol' in this._orderTemplate
                  ...
                  : null) && void 0 !== i
            ? i
            : (0, q.safeSplitSymbol)(this._orderTemplate.symbol)[1]
        }
      }
      class gt {
        constructor({
          ...
          ;((this._infoTableData$ = new n.BehaviorSubject({ rows: [] })),
            ...
            (this._pipValue = (0, j.calculatePipValue)(e, r.pipValue, this._lotSize)),
            (this._pipValueType$ = o),
            null === e
              ? (this._tradeValue = 0)
              : 'crypto' === this._type
                ? (this._tradeValue = e * i)
                : (this._tradeValue = rt(e, i, r.pipValue, r.pipSize, this._lotSize)),
            a &&
              l &&
        ...
        title() {
          return b.t(null, void 0, i(798565))
        }
        infoTableData() {
        ...
        _getTradeValue() {
          ...
          if (
            ...
            return (0, j.formatInfoValue)(this._tradeValue * (null != e ? e : 1))
        }
        _makeLeverageInfo() {
          const e = (0, j.displayedLeverage)(this._leverage, this._marginRate)
          return null === e ? [] : [{ title: b.t(null, void 0, i(824813)), value: e }]
            ...
            ? [
                {
                  title:
                    e === L.PipValueType.Pips
                      ? b.t(null, void 0, i(207074))
                      : b.t(null, void 0, i(414285)),
                  value: `${(0, j.formatInfoValue)(this._pipValue)} ${this._currency}`,
                },
              ]
            : []
        }
      ...
      class Pt {
          ...
          ;(this._loading$.next(!0),
            this._doneHandler().then((e) => {
              if (e) {
                ...
                ;(e === E.OrderEditorDisplayMode.Popup ||
                e === E.OrderEditorDisplayMode.ResizableDrawer
                  ? this.headerModel.close()
                  : this._back(),
                  this._trackEvent(
                    'Position Ticket',
                    'Modify Position',
                    this._getDisplayMode() === E.OrderEditorDisplayMode.Panel ? 'Panel' : 'Popup',
                  ))
              }
        ...
        _createModels(e, t, i, s, r) {
          ...
          const u = {
            ...
            d = (0, q.getCurrency)(i) || '$',
            h = new n.BehaviorSubject(this._position.side || -1)
          this.headerModel = new se({
            ...
            isTradable: !0,
            data: this._position,
            formatter: this._position.priceFormatter ? this._position.priceFormatter : s,
            headerState: this._headerState,
            brokerId: null === (o = this._adapter) || void 0 === o ? void 0 : o.metainfo().id,
          })
          ...
          this.takeProfitModel = new ie({
            ...
            parentPrice$: new n.BehaviorSubject(
              null !== (a = this._position.avgPrice) && void 0 !== a ? a : this._position.price,
            ),
            orderType$: this.orderType$,
            currency: d,
            parentType: 2,
            ...
            validationRulesByType: u,
            supportModifyTrailingStop: c,
          })
          const p = Boolean(this._position.trailingStopPips),
            _ = e.trailingStopPips || this._position.trailingStopPips,
            y = e.stopLoss || this._position.stopLoss,
            b = null !== (l = e.guaranteedStop) && void 0 !== l ? l : this._position.guaranteedStop,
            { makeInitialPrice: g, makeInitialEnabled: v, makeInitialBracketType: P } = ee
          this.stopLossModel = new ie({
            initialPrice: g({ stopLoss: y, trailingStopPips: _, guaranteedStop: b }),
            initialEnabled: v({ stopLoss: y, trailingStopPips: _, guaranteedStop: b }),
            initialBracketType: P({ stopLoss: y, trailingStopPips: _, guaranteedStop: b }),
            formatter: s,
            equity$: this._equity$,
            quotes$: this._quotes$,
            info: t,
          ...
          const k = (0, j.shouldShowTotal)(r),
            m = this.supportBrackets()
          ;(this.supportCryptoExchangeOrderTicket ||
            (this.positionInfoModel = new gt({
              qty: this._position.qty,
              currency: (0, q.getCurrency)(i),
              positionPrice: this._position.avgPrice,
              showTotalInsteadOfTradeValue: k,
              info: t,
              pipValueType$: this._pipValueType$,
              tpInfo:
                m && this.takeProfitModel
            ...
            (this.buttonModel = new st(L.TradingEntityType.Position)))
        }
        _updateWarning() {
          this._adapter.orders().then((e) => {
            ...
            this._warning$.next(t ? b.t(null, void 0, i(913064)) : void 0)
          })
        }
        _subscribe() {
          if (
            ...
            this.headerModel.backButtonClicked().subscribe(this, this._back),
            this.headerModel.closeButtonClicked().subscribe(this, this._closeWidget),
            (this._buttonDataSubscription = (0, M.combineLatest)({
              loading: this._loading$,
              quotes: this._quotes$,
              ...
              this._isButtonDisabled$.next(
                t || (0, q.isNoQuotes)(i) || (o && null === s) || (n && null === r),
              )
            })),
            (this._rewardRiskSubscription = (0, M.combineLatest)([
              this.takeProfitModel.value$,
              this.stopLossModel.value$,
            ]).subscribe(([e, t]) => {
              this._rewardRisk$.next((0, j.formatRiskReward)(e, t))
            ...
            const e = this.stopLossModel.enabled$
                .pipe(B(this.takeProfitModel.enabled$))
                .subscribe((e) => {
                  const [t, i] = e
                  i !== t && this.takeProfitModel.setEnabled(t)
                }),
              t = this.takeProfitModel.enabled$
                .pipe(B(this.stopLossModel.enabled$))
                .subscribe((e) => {
                  const [t, i] = e
        ...
        _doneHandler() {
          ...
          if (
            (null !== t &&
              null !== e &&
              (this.stopLossModel.getBracketType() === L.BracketType.StopLoss && (s.stopLoss = e),
              this.stopLossModel.getBracketType() === L.BracketType.TrailingStop &&
            ...
            return (this._getAndSendStatistics(), this._handler(this.position.id, s, e))
          }
      ...
      class mt {
        ...
        saveSettings(e) {
          this._settingsAdapter.setValue(
            this._makeKey(kt.settingsKeys.ORDER_PANEL_SETTINGS, this._brokerId),
            JSON.stringify(e),
          )
        }
        getSettings() {
        ...
        setWidgetMode(e) {
          this._settingsAdapter.setValue(kt.settingsKeys.ORDER_WIDGET_MODE, e)
        }
        widgetMode() {
          const e = this._settingsAdapter.getValue(kt.settingsKeys.ORDER_WIDGET_MODE)
          return e || null
        }
        _makeKey(e, t, i) {
      ...
      const Vt = {
          [Ct.PlaceOrEditContextType.PlaceOrder]: E.OrderPanelStatus.Active,
          [Ct.PlaceOrEditContextType.EditOrder]: E.OrderPanelStatus.Editing,
          [Ct.PlaceOrEditContextType.EditPosition]: E.OrderPanelStatus.Editing,
          [Ct.PlaceOrEditContextType.EditIndividualPosition]: E.OrderPanelStatus.Editing,
        },
        It = (0, p.getLogger)('Trading.OrderViewController')
      function Ot() {
        return Promise.all([
          i.e(3689),
          i.e(6625),
      ...
      class Et {
        constructor(e) {
          ;((this._orderViewModel = null),
            ...
            (this._dialogVisibility = new Mt.DialogVisibility()),
            (this._orderWidgetStat = null),
            (this._stopSubscriptions$ = new o.Subject()),
            (this._isOrderSizeCalculatorEnabled = !1),
            (this._settings$ = new n.BehaviorSubject($t.defaultSettings)),
            (this._mode$ = new n.BehaviorSubject(E.OrderEditorDisplayMode.Panel)),
            (this.openPanel = async () => {
              ...
              try {
                ;(this._unsubscribeViewModels(),
                  ...
                  this._setDisplayMode(E.OrderEditorDisplayMode.Panel),
                  this._openTradingPanelPage(St.TradingPage.OrderPanel))
                const t =
                ...
                ;(await this._recreateOrderViewModel(null, t),
                  await this._openOrderPanel(this._getDefaultOrderTicketFocus()))
              } catch (e) {
                ;(It.logWarn(`Failed to open panel: ${(0, y.getLoggerMessage)(e)}`),
                  this.closePanel())
              }
            }),
            (this.closePanel = () => {
              ...
              try {
                ...
                ;(i.symbol === t.symbol &&
                  ...
                  !(null == e ? void 0 : e.aborted) &&
                    ...
                    this.getDisplayMode() === E.OrderEditorDisplayMode.Panel &&
                    this._tradingPanelActivePage.value() === St.TradingPage.OrderPanel &&
                    (await this._recreateOrderViewModel(e),
                    this._deactivateOrderTicket(),
                    this._openOrderPanel()))
              } catch (e) {
                It.logWarn(`Failed to change status: ${(0, y.getLoggerMessage)(e)}`)
              }
            }),
            (this._recreateOrderViewModel = async (e, t) => {
              ...
              if (null === l)
                ...
                const a = await (0, Ge.respectAbort)(e, l.isTradable(u))
                let c = l.placeOrder.bind(l)
                void 0 !== this._tradedContextLinking &&
                  (c = async (e, t) => {
                ...
                const p = this._orderStub.hasOwnProperty('id') ? l.modifyOrder.bind(l) : c,
                  _ = async (e) => {
                    var t
                    const i =
                      null === (t = this._tradedContextLinking) || void 0 === t
                        ? void 0
                        : t.context()
                    return (null == i ? void 0 : i.type) === Ct.PlaceOrEditContextType.PlaceOrder
                      ? i.preview()
                      : l.previewOrder(e)
                  }
                let y = null
                    ...
                    null !==
                      (n =
                        null !==
                          ...
                          ? o
                          : (0, q.getDefaultOrderType)(l.config)) && void 0 !== n
                      ? n
                      : null)
                const b = await (0, Ge.respectAbort)(e, l.getOrderDialogOptions(u)),
                  g = void 0 !== (null == b ? void 0 : b.customFields) ? Lt(b.customFields) : null
                this._setState({ orderType: y, savableCustomFields: g })
                const v = this._makeOrderViewInputState(u, y, d, g)
                h = new bt({
                  ...this._commonOrderViewModelProps(),
                  adapter: l,
                  isTradable: a,
                  ...
                  orderDialogOptions: b,
                })
              }
              if (
                ((this._orderViewModel = h),
                this._subscribeOrderViewModel(),
                await (0, Ge.respectAbort)(e, h.onReady),
                this._orderViewModel !== h)
              )
                return (
                  this._unsubscribeViewModels(),
                  Promise.reject('OrderViewModel was recreated during the initialization')
                )
              ;(null === (a = this._placeOrderAbortController) || void 0 === a || a.abort(),
                (this._placeOrderAbortController = new AbortController()),
                this._updateTradedContextLinking(this._placeOrderAbortController.signal))
            }),
            (this._updateTradedContextLinking = async (e) => {
              if (
                !(
                  ...
                  null === this._orderViewModel ||
                  this._orderViewModel.existingOrder ||
                  this._orderViewModel.getStatus() === E.OrderPanelStatus.Wait ||
                ...
                try {
                  if (this._orderViewModel.getStatus() === E.OrderPanelStatus.Wait) return
                  const t = await (0, Ge.respectAbort)(
                    e,
            ...
            (this._updateOrderValues = (e) => {
              ...
              ;(void 0 !== i && this._orderViewModel.limitPriceModel.setPriceValue(i),
                void 0 !== n && this._orderViewModel.stopPriceModel.setPriceValue(n),
                this._orderViewModel.sideModel.getValue() !== o &&
                  this._orderViewModel.sideModel.setValue(o),
                this._orderViewModel.getOrderType() !== s && this._orderViewModel.setOrderType(s),
                this._orderViewModel.quantityModel.quantity.getValue() !== r &&
                  this._orderViewModel.quantityModel.quantity.setValue(r),
                this._orderViewModel.durationModel.currentDuration.setValue(null != t ? t : null),
                ...
                void 0 !== this._orderViewModel.takeProfitModel &&
                  this._updateTakeProfitValues(this._orderViewModel.takeProfitModel, l))
            }),
            (this._onOrderWidgetModeChanged = async (e) => {
              const t = this._getDefaultOrderTicketFocus()
              ;(e === E.OrderEditorDisplayMode.Panel
                ? (await this._closeOrderDialog(), await this._openOrderPanel(t))
                : e === E.OrderEditorDisplayMode.Popup
                  ? (await this._closeOrderPanel(),
                    this._activateOrderTicket(),
                    await this._showOrderDialog(t))
            ...
            (this._onOrderWidgetInputStateChanged = (e) => {
              ...
              this._updateTradedContextLinking(
                null !==
                  (i =
                    null === (t = this._placeOrderAbortController) || void 0 === t
                      ? void 0
                      : t.signal) && void 0 !== i
                  ? i
                  : null,
              )
              const { symbol: o, orderType: n } = this._state
              if (
                ((0, q.isDefined)(e.side) && this._setState({ side: e.side }), !(0, q.isDefined)(n))
              )
                return
              const a = this._getTradingSettingsStorage()
              if (null === a) return
              const l = (0, r.ensureNotNull)(this._orderViewModel, 'Order View Model').existingOrder
              if (
                ((0, q.isDefined)(e.quantity) && a.setSymbolQty(o, e.quantity),
                this._isOrderSizeCalculatorEnabled &&
                  !l &&
                  (0, q.isDefined)(e.orderSizeCalculatorQuantityType) &&
                  a.setOrderSizeCalculatorQuantityType(o, e.orderSizeCalculatorQuantityType),
                this._isOrderSizeCalculatorEnabled &&
                  (0, q.isDefined)(e.lastRiskQuantityType) &&
                  s.setValue(kt.settingsKeys.LAST_RISK_QUANTITY_TYPE, e.lastRiskQuantityType),
                this._isOrderSizeCalculatorEnabled &&
                  (0, q.isDefined)(e.lastUsedQuantityType) &&
                  a.setLastUsedQuantityType(o, e.lastUsedQuantityType),
                this._isOrderSizeCalculatorEnabled &&
                  (0, q.isDefined)(e.orderSizeCalculatorValue) &&
                  a.setOrderSizeCalculatorValue(o, e.orderSizeCalculatorValue),
                (0, q.isDefined)(e.takeProfitPips) &&
                  a.setTakeProfitPips(o, e.takeProfitPips, E.BracketDefaultPips.TakeProfit),
                (0, q.isDefined)(e.stopLossPips) &&
                  a.setStopLossPips(o, e.stopLossPips, E.BracketDefaultPips.StopLoss),
                (0, q.isDefined)(e.orderType) && a.setOrderType(o, e.orderType),
                (0, q.isDefined)(e.duration))
              ) {
                ...
                a.setDuration(this._state.symbol, n, s)
              }
              if ((0, q.isDefined)(e.customFields) && null !== this._state.savableCustomFields) {
            ...
            (this._onOrderWidgetStatusChanged = (e) => {
              var t, i
              const s =
                e === E.OrderPanelStatus.Editing &&
                null !==
                  (null === (t = this._tradedContextLinking) || void 0 === t ? void 0 : t.context())
              ;((e === E.OrderPanelStatus.Wait || s) &&
                (this._updateTradedContextLinking(null),
                null === (i = this._tradedContextLinking) || void 0 === i || i.setContext(null)),
                e === E.OrderPanelStatus.Active &&
            ...
            (this._onOrderWidgetBackButtonClicked = () => {
              if (
                ...
                this._orderViewModel.getStatus() === E.OrderPanelStatus.Preview
              ) {
                this._activateOrderTicket()
                const e = this._getDefaultOrderTicketFocus()
                this.getDisplayMode() === E.OrderEditorDisplayMode.Panel
                  ? this._openOrderPanel(e)
                  : this.getDisplayMode() === E.OrderEditorDisplayMode.Popup
                    ? this._showOrderDialog(e)
                    : this._showOrderDrawer(e)
              } else this.showOrderView({ order: this._createOrderStub(), isDeactivated: !0 })
            }),
            ...
            (this._toggleMode = () => {
              this._setDisplayMode(
                this.getDisplayMode() === E.OrderEditorDisplayMode.Panel
                  ? E.OrderEditorDisplayMode.Popup
          ...
          const {
            ...
            qtySuggester: a,
            tradingLinking: l,
            orderViewHeaderState: u,
            tradedContextLinking: d,
          } = e
          if (
            ((this._orderViewHeaderState = u),
            (this._updateTradedContextLinking = (0, Ge.respectLatest)(
              this._updateTradedContextLinking,
            )),
            (this._tradingCommands = t),
            (this._trackEvent = t.trackEvent),
            (this._realtimeProvider = t.realtimeProvider),
            (this._orderViewDataStorage = new mt(s)),
            ...
            window.matchMedia(Tt.TradingLayoutBreakpoint.Mobile).matches)
          )
            this._setDisplayMode(E.OrderEditorDisplayMode.Popup)
          else if (_.enabled('order_panel')) {
            const e = this._orderViewDataStorage.widgetMode()
            this._setDisplayMode(null != e ? e : E.OrderEditorDisplayMode.Panel)
          } else this._setDisplayMode(E.OrderEditorDisplayMode.Popup)
          ;(i.isOpeningAvailable.subscribe((e) => {
            ...
            (this.stateChanging = ft.value),
            (this._onStatusChanged = (0, Ge.respectLatest)(this._onStatusChanged)),
            (this._recreateOrderViewModel = ft.wrap(
              (0, Ge.respectLatest)(this._recreateOrderViewModel),
            )),
            (this.openPanel = ft.wrap(this.openPanel)),
            this._realtimeProvider.onStatusChanged.subscribe(null, () =>
              this._onStatusChanged(null),
            ),
            this._tradingLinking.valueObservable().subscribe(this._handleSymbolChange),
        ...
        async showOrderView(e) {
          try {
            ...
            ;(this._unsubscribeViewModels(),
              await this._closeOrderDialog(),
              await this._closePositionDialog(),
              s && this._setDisplayMode(E.OrderEditorDisplayMode.Popup))
            ...
            const a = null != i ? i : this._getDefaultOrderTicketFocus()
            return (
              this.getDisplayMode() === E.OrderEditorDisplayMode.Panel
                ? this._openOrderPanel(a)
                : this.getDisplayMode() === E.OrderEditorDisplayMode.Popup
                  ? this._showOrderDialog(a)
                  : this._showOrderDrawer(a),
              await (0, r.ensureNotNull)(this._orderViewModel).onDoneButtonClicked.promise
            )
          } catch (e) {
            return (It.logWarn(`Failed to show order view: ${(0, y.getLoggerMessage)(e)}`), !1)
          }
        }
        async showPositionView(e, t, i) {
          try {
            ...
            return (It.logWarn(`Failed to show position view: ${(0, y.getLoggerMessage)(e)}`), !1)
          }
        }
        async showIndividualPositionView(e, t, i) {
          try {
            return (
              ...
              await this._createAndShowPositionViewModel({
                position: e,
                viewType: vt.IndividualPosition,
                brackets: t,
                focus: i,
              })
            )
            ...
            return (
              It.logWarn(`Failed to show individual position view: ${(0, y.getLoggerMessage)(e)}`),
              !1
            )
          }
        }
        ...
        _makeState() {
          ...
          const r = window.is_authenticated,
            ...
            l = void 0 !== a ? (0, q.getDefaultOrderType)(a) : null,
            u =
              null !==
                (i =
                  null !==
        ...
        _setSettings() {
          ...
          null === (e = this._settingsSubscription) || void 0 === e || e.unsubscribe()
          let t = Object.assign({}, $t.defaultSettings, this._orderViewDataStorage.getSettings())
          ;(this._state.broker.metainfo().configFlags.supportCryptoBrackets &&
            (t = Object.assign({}, $t.defaultCryptoBracketsSettings, t)),
            this._settings$.next(t),
              ...
              ? (this._setErrorsState(e.errors()),
                e.source() !== Dt &&
                  (this._orderViewModel.setLoading(
                    e.status() === Ct.PlaceOrEditContextStatus.Loading,
                  ),
                  this._orderViewModel.setStatus(Vt[e.type]),
                  this._updateOrderValues(e.data())))
              : this._orderViewModel.getStatus() !== E.OrderPanelStatus.Editing &&
                this._orderViewModel.resetOrderPanel())
        }
        _setErrorsState(e) {
          var t, i, s, r
          if (null === this._orderViewModel) return
          const o = e.stopLoss || e.trailingStopPips || e.guaranteedStop
          ;(e.limitPrice
            ...
            o
              ? null === (t = this._orderViewModel.stopLossModel) ||
                void 0 === t ||
                t.setControlError(!0, (0, y.getErrorMessage)(o))
              : null === (i = this._orderViewModel.stopLossModel) ||
                void 0 === i ||
                i.setControlError(!1),
            e.takeProfit
              ? null === (s = this._orderViewModel.takeProfitModel) ||
                void 0 === s ||
                s.setControlError(!0, (0, y.getErrorMessage)(e.takeProfit))
              : null === (r = this._orderViewModel.takeProfitModel) ||
                void 0 === r ||
                r.setControlError(!1))
        }
        ...
        _updateStopLossValues(e) {
          ...
          ;(t.getEnabled() !== n && t.setEnabled(n),
            void 0 !== o &&
              t.getBracketType() !== (0, q.getBracketTypeByStopType)(o) &&
              t.setBracketType((0, q.getBracketTypeByStopType)(o)))
        ...
        async _openOrderPanel(e) {
          ;(await this._mountOrderPanel(e), this._openTradingPanelPage(St.TradingPage.OrderPanel))
        }
        async _mountOrderPanel(e) {
          const { mountOrderPanel: t } = await Ot()
          null !== this._orderViewModel &&
            t({
              ...
              onClose: () => {
                ...
                ;(this._dialogVisibility.setValue({ isVisible: !1 }),
                  null === (e = this._orderViewModel) ||
                    void 0 === e ||
                    e.onDoneButtonClicked.resolve(!1),
                  this._unsubscribeViewModels())
              },
            })
        }
        async _closeOrderDialog() {
          const { closeOrderDialog: e } = await Ot()
          e(() => this._dialogVisibility.setValue({ isVisible: !1 }))
        }
        async _showOrderDrawer(e) {
          const { showOrderDrawer: t } = await Ot()
          null !== this._orderViewModel &&
            t({
              viewModel: this._orderViewModel,
              settings$: this._settings$,
              mode: this.getDisplayMode(),
              focus: null != e ? e : this._getDefaultOrderTicketFocus(),
              trackEvent: this._trackEvent,
              onOpen: (e) => {
                this._dialogVisibility.setValue({ isVisible: !0, isFullScreen: e })
              },
        ...
        _subscribeOrderViewModel() {
          ...
          ;((this._stopSubscriptions$ = new o.Subject()),
            null === (e = this._tradedContextLinking) ||
              void 0 === e ||
              e.onContextChanged().subscribe(this, this._handleTradedContextChange),
            ...
            (0, r.ensureNotNull)(this._orderViewModel)
              .orderType$.pipe(h(this._stopSubscriptions$))
              .subscribe(this._onOrderTypeChanged),
            (0, r.ensureNotNull)(this._orderViewModel)
              .status$.pipe(h(this._stopSubscriptions$))
              .subscribe(this._onOrderWidgetStatusChanged),
            this._mode$
              .pipe(h(this._stopSubscriptions$), (0, c.skip)(1))
        ...
        _unsubscribeOrderViewModel() {
          ...
          ;(null === (e = this._tradedContextLinking) ||
            void 0 === e ||
            e.onContextChanged().unsubscribe(this, this._handleTradedContextChange),
        ...
        _getDefaultOrderTicketFocus() {
          var e
          switch (null === (e = this._orderViewModel) || void 0 === e ? void 0 : e.getOrderType()) {
            case 2:
              return 5
            case 1:
            case 4:
        ...
        async _mountPositionPanel(e) {
          const { mountPositionPanel: t } = await Bt()
        ...
        async _unmountPositionPanel() {
          const { unmountPositionPanel: e } = await Bt()
          e(this._tradingPanelContainer)
        }
        async _showPositionDialog(e) {
          const { showPositionDialog: t } = await Bt()
          null !== this._positionViewModel &&
            t({
              ...
              onClose: () => {
                var e
                ;(this._dialogVisibility.setValue({ isVisible: !1 }),
                  null === (e = this._positionViewModel) ||
                    void 0 === e ||
                    e.onDoneButtonClicked.resolve(!1),
                  this._unsubscribeViewModels())
              },
        ...
        async _closePositionDialog() {
          const { closePositionDialog: e } = await Bt()
          e(() => this._dialogVisibility.setValue({ isVisible: !1 }))
        }
        async _showPositionDrawer(e) {
          const { showPositionDrawer: t } = await Bt()
          null !== this._positionViewModel &&
            t({
              viewModel: this._positionViewModel,
              settings$: this._settings$,
        ...
        _makeOrderViewInputState(e, t, i, r) {
          var o, n, a, l, u, d, h, c, p
          const _ =
              null !== r && null !== t
                ? null === (o = this._getTradingSettingsStorage()) || void 0 === o
                  ? void 0
                  : o.customFields(e, t, Array.from(r))
                : null,
            y =
              null !== t
            ...
            orderSizeCalculatorQuantityType:
              (this._isOrderSizeCalculatorEnabled &&
                (null === (l = this._getTradingSettingsStorage()) || void 0 === l
                  ? void 0
                  : l.orderSizeCalculatorQuantityType(e))) ||
              null,
            lastRiskQuantityType:
              this._isOrderSizeCalculatorEnabled &&
              null !== (u = s.getValue(kt.settingsKeys.LAST_RISK_QUANTITY_TYPE)) &&
              void 0 !== u
                ? u
                : null,
            lastUsedQuantityType:
              (this._isOrderSizeCalculatorEnabled &&
                (null === (d = this._getTradingSettingsStorage()) || void 0 === d
                  ? void 0
                  : d.lastUsedQuantityType(e))) ||
              null,
            orderSizeCalculatorValue:
              (this._isOrderSizeCalculatorEnabled &&
                (null === (h = this._getTradingSettingsStorage()) || void 0 === h
                  ? void 0
                  : h.orderSizeCalculatorValue(e))) ||
              null,
            takeProfitPips:
              (null === (c = this._getTradingSettingsStorage()) || void 0 === c
                ? void 0
                : c.takeProfitPips(e)) || null,
            takeProfitPrice: null,
            stopLossPips:
              (null === (p = this._getTradingSettingsStorage()) || void 0 === p
                ? void 0
                : p.stopLossPips(e)) || null,
            stopLossPrice: null,
            duration: y || null,
            customFields: _ || null,
            bracketType: null,
    ...
    466479: (e, t, i) => {
      ...
      var s = i(947488),
        ...
        l = i(328810)
      class u {
        constructor({ existingOrder: e, customFields: t, initialInputState: i, orderType$: a }) {
          ;((this._isEmptyRequiredCustomFieldsHighlighted$ = new s.BehaviorSubject(!1)),
            ...
            (this._subscriptions = []),
            (this.getCustomFieldsInputValues = () => this._customFieldsInputValues$.getValue()),
            (this.isCustomFieldsNotSelected$ = this._isCustomFieldsNotSelected$.asObservable()),
            (this.customFieldsInputValues$ = this._customFieldsInputValues$.asObservable()),
            (this._orderType$ = a),
        ...
        subscribe() {
          const e = this._anyCustomFieldValueChangeObservable().subscribe(() => {
              ;(this._calculateCustomFieldsInputValues(), this._checkIsCustomFieldsNotSelected())
            }),
        ...
        unsubscribe() {
          ;(this._subscriptions.forEach((e) => (null == e ? void 0 : e.unsubscribe())),
            (this._subscriptions = []),
        ...
        _checkIsCustomFieldsNotSelected() {
          const e = this._customFieldModels$
            .getValue()
            .flatMap((e) => ('ComboBox' === e.type && void 0 === e.getSelectedItem() ? e : []))
        ...
        _getCustomFieldsInputValues(e) {
          ...
          return (
            e.forEach((e) => {
              ;('TextWithCheckBox' === e.type &&
                (t[e.id] = { text: e.getText().replace(/&quote;/g, '"'), checked: e.getChecked() }),
